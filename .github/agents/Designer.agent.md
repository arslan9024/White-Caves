...
> _"Named after Una Kravets — CSS champion and creative coder. I turn brand visions into pixel-perfect reality."_
...
:root {
  ...
  --wc-gold-shimmer: linear-gradient(
    90deg,
    transparent 0%,
  ...
  --wc-surface-hover: rgba(255, 255, 255, 0.1); /* Glass on hover */
