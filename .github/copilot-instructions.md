# White Caves Real Estate LLC — Global Agency Instructions
> **Stack Reality:** React 18 + TypeScript 5 (strict) + Vite + styled-components + Framer Motion + Express 5 + Prisma + MongoDB  
> _(Agent files reference Next.js/Tailwind as targets; current codebase uses Vite/styled-components — migrate incrementally)_
