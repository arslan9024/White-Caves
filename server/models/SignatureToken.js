...
const signatureTokenSchema = new mongoose.Schema(
  ...
  {
    timestamps: true,
    indexes: [{ contractId: 1, signerType: 1 }, { signerId: 1 }],
  }
);
...
signatureTokenSchema.statics.createForSigner = async function (
  contractId,
  signerId,
  signerType,
  createdByUserId
...
const SignatureTokenModel =
  mongoose.models.SignatureToken || mongoose.model('SignatureToken', signatureTokenSchema);
