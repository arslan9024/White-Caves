...
const ARABIC_INTENT_KEYWORDS: Record<string, string[]> = {
  property_search: [
    'عقار', 'شقة', 'فيلا', 'تاون هاوس', 'بنتهاوس', 'استوديو', 'غرفة',
    'أبحث عن', 'أريد شراء', 'أريد إيجار', 'متاح', 'معروض للبيع',
    'عقارات دبي', 'مشروع سكني', 'وحدة سكنية',
  ],
  information_request: [
    'معلومات', 'تفاصيل', 'سعر', 'مساحة', 'طابق', 'إطلالة', 'مرافق',
    'كم سعر', 'كم الإيجار', 'ما هو السعر', 'تكلفة', 'رسوم', 'عمولة',
    'موقع', 'قريب من', 'بجانب',
  ],
  schedule_tour: [
    'معاينة', 'جولة', 'زيارة', 'مشاهدة', 'عرض', 'تفقد',
    'أريد معاينة', 'هل يمكن الزيارة', 'متى يمكن', 'موعد',
  ],
  make_offer: [
    'عرض سعر', 'أقدم عرض', 'مفاوضة', 'تفاوض', 'قابل للتفاوض',
    'سأدفع', 'أقبل', 'صفقة', 'حجز',
  ],
  financing: [
    'تمويل', 'قرض', 'رهن عقاري', 'بنك', 'دفعة أولى', 'قسط',
    'تمويل عقاري', 'اقتراض', 'بالتقسيط',
  ],
  complaint: [
    'مشكلة', 'شكوى', 'خلل', 'عيب', 'تلف', 'صيانة',
    'غير راضٍ', 'مخالف للاتفاق', 'لم يلتزم',
  ],
  general_inquiry: [
    'سؤال', 'استفسار', 'مرحبا', 'السلام عليكم', 'أهلاً', 'صباح الخير',
    'مساء الخير', 'شكراً', 'مساعدة',
  ],
};
