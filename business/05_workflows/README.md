...
**Owner**: Nina (Bot) + Linda (Agents) + Clara (Lead Manager)
...
- WhatsApp broadcast campaigns (Linda)
- SEO optimization (for listings)
- Paid ads (Google, Facebook)
         ↓
Lead Capture (Multi-Channel)
- Direct messaging on social platforms (→ Linda)
...
**Owner**: Linda (Communications) + departmental escalation
...
- Auto-resolution via Linda templates
- Customer confirmation
- Closed
         ↓
[Complex Issue - 60% of cases]
- Route to appropriate department
- Linda (communications) → Escalation
...
Customer (WhatsApp)
    ↓
Nina Bot ←-→ Linda (Agents) - 24/7 Coverage
    ↓
Clara (Lead CRM)
    ↓
...
- **Linda Escalation**: Customer asks for human, Bot confidence <60%, Complex negotiation required
