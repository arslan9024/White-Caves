...
> **Document ID:** WC-PERF-001
> **Version:** 1.0
> **Date:** April 2026
> **Status:** Active
> **Owner:** HR Department + Compliance (Katherine — QA Lead, Jaime — Productivity Lead)
> **Scope:** KPIs per agent role, scoring methodology, review cadence

---

## 1. Performance Philosophy

White Caves measures performance on **what matters for the client** — not just transaction volume. A great agent:

- Responds fast (client experience)
- Qualifies well (not just quantity)
- Complies fully (regulatory trust)
- Maintains accurate CRM data (team efficiency)
- Closes with integrity (reputation)

---

## 2. Role-Based Scorecards

### 2.1 Sales Agent / Senior Sales Agent

**Review frequency:** Monthly review, quarterly formal appraisal

| KPI                     | Measurement                                | Weight | Bronze | Silver | Gold  |
| ----------------------- | ------------------------------------------ | ------ | ------ | ------ | ----- |
| Lead response time      | AVG(first activity - lead.createdAt)       | 15%    | < 4h   | < 2h   | < 1h  |
| Lead qualification rate | Leads moved to QUALIFIED / total assigned  | 15%    | > 20%  | > 35%  | > 50% |
| Viewing conversion      | Viewings arranged / QUALIFIED leads        | 15%    | > 30%  | > 50%  | > 70% |
| Deal closure rate       | WON / VIEWING stage leads                  | 20%    | > 10%  | > 20%  | > 35% |
| CRM data quality        | % of leads with all required fields filled | 10%    | > 70%  | > 85%  | > 95% |
| Compliance adherence    | % of transactions with complete KYC        | 15%    | 100%   | 100%   | 100%  |
| Client satisfaction     | CSAT post-transaction score (1–10)         | 10%    | > 7.0  | > 8.0  | > 9.0 |

**Bonus threshold:** Gold on 5/7 KPIs = quarterly bonus eligible
...
| KPI                            | Measurement                              | Weight | Bronze    | Silver    | Gold     |
| ------------------------------ | ---------------------------------------- | ------ | --------- | --------- | -------- |
| Tenancy applications processed | COUNT per month                          | 10%    | 5         | 10        | 15       |
| Viewing-to-lease rate          | Leases signed / viewings                 | 20%    | > 25%     | > 40%     | > 55%    |
| Ejari registration time        | AVG days to register after lease signing | 15%    | < 20 days | < 14 days | < 7 days |
| Renewal conversion             | Lease renewals / leases expiring         | 20%    | > 50%     | > 65%     | > 80%    |
| KYC completion                 | % of tenants with complete docs          | 15%    | 100%      | 100%      | 100%     |
| Landlord satisfaction          | Landlord CSAT score                      | 10%    | > 7.0     | > 8.0     | > 9.0    |
| CRM data quality               | Lease records complete                   | 10%    | > 80%     | > 90%     | > 98%    |

---

### 2.3 Sales Manager / Team Lead

| KPI                     | Measurement                      | Weight | Bronze  | Silver  | Gold    |
| ----------------------- | -------------------------------- | ------ | ------- | ------- | ------- |
| Team lead response time | Team AVG response time to leads  | 15%    | < 3h    | < 2h    | < 1h    |
| Team deal closure rate  | Team WON / VIEWING               | 20%    | > 12%   | > 22%   | > 35%   |
| Pipeline value managed  | AED value of QUALIFIED + VIEWING | 15%    | AED 10M | AED 25M | AED 50M |
| Agent development       | 1:1 coaching sessions held       | 10%    | 2/month | 4/month | 6/month |
| Compliance team rate    | Team KYC completion              | 15%    | 100%    | 100%    | 100%    |
| Commission approval SLA | % approved within 24h SLA        | 10%    | > 80%   | > 90%   | 100%    |
| Team NPS                | AVG client NPS for team          | 15%    | > 60    | > 70    | > 80    |
...
| KPI                         | Measurement                             | Weight | Bronze | Silver | Gold      |
| --------------------------- | --------------------------------------- | ------ | ------ | ------ | --------- |
| KYC completion rate         | % of clients > AED 55k with full KYC    | 30%    | 95%    | 98%    | 100%      |
| AML screening rate          | % of transactions screened              | 20%    | 95%    | 98%    | 100%      |
| SAR filing timeliness       | % of SARs filed within 2 days           | 15%    | 100%   | 100%   | 100%      |
| Compliance breach incidents | COUNT of regulatory violations          | 20%    | 0      | 0      | 0         |
| Staff training completion   | % of agents completing AML training     | 10%    | 80%    | 90%    | 100%      |
| RERA audit readiness        | Audit readiness score (internal review) | 5%     | Pass   | Pass+  | Excellent |
...
Each KPI is scored 1–3:

- Bronze threshold met: 1 point
- Silver threshold met: 2 points
- Gold threshold met: 3 points
- Below Bronze: 0 points

**Overall Score = SUM(KPI score × weight) / MAX possible score × 100**

### 3.2 Performance Bands

| Band                 | Score Range | Status                       |
| -------------------- | ----------- | ---------------------------- |
| Exceeds Expectations | 85–100%     | Bonus eligible               |
| Meets Expectations   | 65–84%      | Satisfactory                 |
| Developing           | 45–64%      | Performance improvement plan |
| Below Expectations   | < 45%       | Formal review required       |

---

## 4. Performance Review Process

### 4.1 Monthly Review (informal)

```
End of each month:
1. KPI dashboard updated from CRM data
2. Agent reviews own scorecard in CRM (Phase 3)
3. Manager reviews team scorecards
4. Flag: any agent in "Developing" band → 1:1 this week
5. Recognition: Gold performers → shout-out in team meeting
```

### 4.2 Quarterly Formal Appraisal

```
Week 1 of new quarter:
1. Agent self-assessment form submitted via CRM
2. Manager prepares appraisal report (KPI data + qualitative feedback)
3. 1-hour appraisal meeting:
   ├── Review last quarter performance
   ├── Celebrate achievements
   ├── Identify development areas
   └── Set goals for next quarter
4. Signed appraisal stored in HR records
5. Bonus calculation if eligible
```

### 4.3 Performance Improvement Plan (PIP)

```
Triggered when: Agent in "Developing" band for 2 consecutive months
Duration: 30 days

Contents:
1. Clear statement of performance gap
2. Specific improvement targets (e.g., "Response time < 2h by end of PIP")
3. Support offered (coaching, training, tools)
4. Review date (30 days)

Outcome:
├── Targets met → Normal review cycle resumes
└── Targets not met → Escalation to HR → potential contract review
```

---

## 5. RERA Compliance KPI (Mandatory — Zero Tolerance)

Any agent failing RERA compliance KPIs is automatically:

- Placed on mandatory compliance training
- Removed from lead assignment until training completed
- Subject to formal disciplinary process if repeat violation

**No exceptions for RERA violations — regulatory risk to company license.**

---

## 6. CRM Data Quality Score

High-quality CRM data is the foundation of AI performance. Low data quality degrades:
...
**Data Quality Checklist per Lead:**
...
- ☐ Area preference
- ☐ Source recorded
- ☐ First contact activity logged within 24h
- ☐ Current status accurate

**Score = % of active leads with all 9 fields complete**

---

## 7. Agent Leaderboard

CRM executive dashboard shows monthly leaderboard:

| Rank | Agent  | Leads Converted | Deals Closed | Commission AED | Score |
| ---- | ------ | --------------- | ------------ | -------------- | ----- |
| 1    | [Name] | XX              | X            | AED XXX,XXX    | 94%   |
| 2    | [Name] | XX              | X            | AED XXX,XXX    | 88%   |
| 3    | [Name] | XX              | X            | AED XXX,XXX    | 83%   |

Visible to: Managing Director, Sales Manager (their team only)
