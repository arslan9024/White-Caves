...
**Priority**: CRITICAL
**Personas**: Nina (Bot), Linda (Agents), Customers
...
- [ ] Escalation to human agent (Linda) when needed
...
#### FR-1.3: Human Agent Escalation (Linda)
...
- [ ] Lead source attribution (Linda WhatsApp, Nina bot, marketing campaign, referral)
