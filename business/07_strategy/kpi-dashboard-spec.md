...
const { data: executiveKPIs, isLoading } = useSWR(
  '/api/kpis/executive',
  fetcher,
  {
...
3. Charts that span a formula change boundary must display a **visual break line** with tooltip: *"KPI formula updated on [date] — see governance doc for details."*
