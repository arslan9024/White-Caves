...
**Source of Truth:** CRM Wave 13 media upload feature specification (business layer)
...
- frontend media UX/performance lanes in `docs/plans/waves/WAVE_39_*` and `WAVE_40_*`
