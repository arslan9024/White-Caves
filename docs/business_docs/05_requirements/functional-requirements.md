...
- [`../09_crm_features/README.md`](../09_crm_features/README.md)
- [`../09_user_roles_permissions/roles-matrix.md`](../09_user_roles_permissions/roles-matrix.md)
- [`../../software_docs/01_requirements_engineering/functional_specifications.md`](../../software_docs/01_requirements_engineering/functional_specifications.md)
- [`../../plans/documentation/REQ_CROSSWALK.md`](../../plans/documentation/REQ_CROSSWALK.md)
- [`../../plans/documentation/COMPLIANCE_CONTROL_MATRIX.md`](../../plans/documentation/COMPLIANCE_CONTROL_MATRIX.md)

## Normalization note

This document remains the canonical business requirement inventory, but formatting and
traceability normalization are still being upgraded in Wave 32. Requirement IDs should be
treated as stable even where layout cleanup is still pending.

## Traceability expectations

Each requirement should progressively map to:

- one or more feature specifications in `docs/business_docs/09_crm_features/`;
