...
> **Timestamp**: 2026-08-08T21:58:34.794Z
> **Total Active Targets**: 1 / 12
...
|---|-------|----------|------|-------------|---------------|
| **1** | `Server` | TypeScript Strictness | [`schema.ts`](file:///C:\Users\HP\Documents\My Web Sites\AntigravityWC\White-Caves\server\graphql\schema.ts) | **MEDIUM** (Score: 100) | Replace explicit `any` with strict interface or generic constraint. |
...
- **Target File**: [`server/graphql/schema.ts:132`](file:///C:\Users\HP\Documents\My Web Sites\AntigravityWC\White-Caves\server\graphql\schema.ts#L132)
