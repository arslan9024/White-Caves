...
| W46-005 | P1       | Business docs consolidation decision: choose canonical root and map migration plan with redirects/pointers                               | @Ada + @Sofia          | Decision record + migration map merged               | 🟡 In Progress |
