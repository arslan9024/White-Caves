...
| :--- | :--- | :--- | :--- |
| **Source Files Scanned** | 4364 | ✅ ACTIVE | Full repository coverage |
| **Nested O(n^2) Array Patterns** | 242 | ⚠️ ATTENTION | Enforce O(n) hash map lookups |
| **Production Console Statements** | 258 | ℹ️ MANAGED | Prune debug logs prior to deploy |
