...
| :--- | :--- | :--- | :--- |
| **Source Files Scanned** | 3063 | ✅ ACTIVE | Full repository coverage |
| **Nested O(n^2) Array Patterns** | 217 | ⚠️ ATTENTION | Enforce O(n) hash map lookups |
| **Production Console Statements** | 255 | ℹ️ MANAGED | Prune debug logs prior to deploy |
