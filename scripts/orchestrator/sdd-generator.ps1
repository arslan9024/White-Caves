...
$L.Add("|------|-------|--------|------|-------|")
$L.Add("| Chief Architect | @Ada | PENDING | | Must declare: Context Ready (60% Readiness) |")
...
$L.Add("")
$L.Add("> When ALL sign-offs are APPROVED and readiness-packet.ps1 reports >= 60%:")
$L.Add("> ``@Ada — Context Ready (60% Readiness) — Coding Phase Approved``")
$L.Add("")
$L.Add("---")
