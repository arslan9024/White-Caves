...
```
@Victoria â€” REVIEW: tenancy-ejari.md â†’ check gaps, verify all acceptance criteria have testable definitions
@Invoice  â€” REVIEW: financial-reporting.md â†’ verify all AED calculations are consistent; add invoice TRN format
@Sofia    â€” REVIEW: compliance-requirements.md â†’ check for missing RERA 2024 updates; verify UAE PDPL sections
@Cassie   â€” EXPAND: analytics-dashboard.md â†’ add mobile analytics view spec + data export CSV/Excel API endpoint spec
@Joelle   â€” EXPAND: 03_ai_assistants/README.md â†’ add FEEDS_ACK from @Margaret for Phase N+1 context readiness
```

### V3 Free-Agent Invocation Pack (Implementation-Spec Writers)

```
@Cron       â€” DRAFT: wave-12-automation-engine.md â†’ SchedulerService, cron cadence table, failure escalation matrix
@Puppeteer  â€” DRAFT: wave-12-document-engine.md â†’ DocumentService PDF/Excel API contracts + streaming behavior
@Handlebars â€” DRAFT: wave-12-email-wiring.md â†’ template registry + event-to-template binding + retry logic
@Socket     â€” DRAFT: wave-13-realtime-notifications.md â†’ Socket auth, room strategy, push event contract
@Cloudinary â€” DRAFT: wave-13-media-upload.md â†’ image upload schema, transforms, retention, rollback plan
@Pannellum  â€” DRAFT: wave-13-virtual-tour.md â†’ VR route contract + lazy loading + fallback behavior
@Zod        â€” DRAFT: wave-14-validation-architecture.md â†’ Zod validation map + error envelope standard
@LeadScore  â€” DRAFT: wave-14-product-automation.md â†’ lead auto-rescore + audit-log UI acceptance tests
@Mortgage   â€” DRAFT: wave-14-finance-features.md â†’ mortgage API, calendar sync, FX conversion acceptance tests
@Redis      â€” DRAFT: wave-15-cache-performance.md â†’ cache key strategy + invalidation + pool sizing
@PWA        â€” DRAFT: wave-15-pwa-readiness.md â†’ SW lifecycle + offline scope + rollback conditions
@S5         â€” DRAFT: wave-16-security-hardening.md â†’ /api/v1 migration + CSRF enforcement model
```

**Free Tool Links:**

- @Victoria, @Sofia: [Google AI Studio](https://aistudio.google.com/) â†’ Model: Gemini 2.0 Flash
- @Invoice, @Joelle: [Groq Console](https://console.groq.com/) â†’ Model: Llama 3.1 70B
- @Cassie: [DeepSeek Chat](https://chat.deepseek.com/) â†’ Model: DeepSeek V3
...
- **Technical Debt:** AEGIS will aggressively prune dead code and unused components using `dead-code-sweep.ps1`.
...
## ðŸš€ AEGIS 150 â€” ORCHESTRATOR MODEL (Active as of 2026-05-25)
...
## ðŸš€ AGENT SKILLS UPGRADE V3 â€” ACTIVE (May 24, 2026)

**TRANSFORMATION:** 70 agents â†’ **100 specialized agents** | **12 delivery teams + Research Division + Executive Council** | **Research Intelligence Division: 20 dedicated analysts** | **6-team parallel planning**  
**EXECUTION MODEL:** True parallel work with module isolation, real-time research feed, and cross-module coordination  
**STATUS:** Full rollout active â†’ [AGENT_SKILLS_UPGRADE_V3.md](./plans/AGENT_SKILLS_UPGRADE_V3.md)  
**PREVIOUS:** V2 (May 21, 2026) archived â†’ [AGENT_SKILLS_UPGRADE_V2.md](./AGENT_SKILLS_UPGRADE_V2.md)

### Quick Navigation â€” 14 Organizational Units

| #    | Unit                           | Lead         | Deputy     | Size | Focus Area                                       | Capacity   |
| ---- | ------------------------------ | ------------ | ---------- | ---- | ------------------------------------------------ | ---------- |
| ðŸ›  | **Executive Council**          | @Ada (Arch)  | @Zoe (COO) | 5    | Architecture, strategy, operations, research     | Governance |
| ðŸ”¬ | **Research Intelligence**      | @Elena (CRO) | @Iris      | 20   | Market research, legal intel, AI/ML, competitive | +500% â†‘  |
| 1    | **Frontend & UX**              | @Una         | @Cyra      | 8    | React components, animations, design tokens      | 200% â†‘   |
| 2    | **Backend & API**              | @Mira        | @Petra     | 6    | Express routes, auth APIs, real-time             | 200% â†‘   |
| 3    | **Database & Data**            | @Barbara     | @Anima     | 5    | Prisma, MongoDB, pipelines, governance           | 200% â†‘   |
| 4    | **Security & QA**              | @Katherine   | @Vera      | 8    | Pen testing, test matrices, WCAG                 | 300% â†‘   |
| 5    | **DevOps & Infrastructure**    | @Gwynne      | @Pola      | 6    | CI/CD, cloud, monitoring, cost                   | 500% â†‘   |
| 6    | **Leasing & Tenancy**          | @Victoria    | @Tara      | 8    | Ejari, PDC, tenant portal, landlord portal       | 200% â†‘   |
| 7    | **Compliance & Legal**         | @Sofia       | @Neva      | 6    | RERA/DLD, UAE PDPL, AML, legal docs              | 200% â†‘   |
| 8    | **Finance & Analytics**        | @Invoice     | @Dora      | 8    | VAT, cash flow, KPI dashboards                   | 300% â†‘   |
| 9    | **Sales & CRM**                | @Jaime       | @Mila      | 6    | Offers, lead routing, CRM automation             | 200% â†‘   |
| 10   | **Communications & Marketing** | @Rachel      | @Reem\*    | 7    | SEO, WhatsApp, campaigns, community              | 200% â†‘   |
| 11   | **AI & Integrations**          | @Joelle      | @Zainab    | 6    | AI personas, webhook specs, queue mgmt           | 200% â†‘   |
| 12   | **Operations & Maintenance**   | @Rania       | @Dina      | 6    | Tickets, audit trail, ops runbooks               | 200% â†‘   |
...
â†’ **See full V3 upgrade details:** [plans/AGENT_SKILLS_UPGRADE_V3.md](./plans/AGENT_SKILLS_UPGRADE_V3.md)

## ðŸš€ AGENT SKILLS UPGRADE V2 â€” ACTIVE (May 21, 2026)

**TRANSFORMATION:** 47 agents â†’ **81 specialized agents** | **10 parallel module teams** | **300% planning capacity**  
**EXECUTION MODEL:** True parallel work with module isolation + real-time cross-module coordination  
**STATUS:** Skills upgrade documentation complete â†’ [AGENT_SKILLS_UPGRADE_V2.md](./AGENT_SKILLS_UPGRADE_V2.md)

### Quick Navigation to Module Teams

| Module                           | Lead      | Team Size | Focus Area                               | Capacity Gain |
| -------------------------------- | --------- | --------- | ---------------------------------------- | ------------- |
| **1. Leasing & Tenancy**         | @Victoria | 7 agents  | Contracts, Ejari, tenant portal          | 200% â†‘      |
| **2. Compliance & DLD**          | @Sofia    | 7 agents  | Regulations, DLD integration, legal      | 200% â†‘      |
| **3. Scheduling & Viewings**     | @Booking  | 7 agents  | Calendar, appointments, handover         | 200% â†‘      |
| **4. Offers & Sales**            | @Jaime    | 6 agents  | Deal management, offers, commissions     | 200% â†‘      |
| **5. Finance & Analytics**       | @Invoice  | 7 agents  | VAT, cash flow, KPI dashboards           | 300% â†‘      |
| **6. WhatsApp & Communications** | @Corinne  | 6 agents  | Messaging, chatbot, broadcast            | 200% â†‘      |
| **7. Maintenance & Support**     | @Rania    | 6 agents  | Tickets, maintenance, escalations        | 200% â†‘      |
| **8. Testing & QA**              | @Salma    | 5 agents  | Test matrices, regression, accessibility | 200% â†‘      |
| **9. AI & Recommendations**      | @Joelle   | 5 agents  | Personas, chatbots, scoring              | 200% â†‘      |
| **10. Infrastructure & Ops**     | @Gwynne   | 5 agents  | DevOps, cloud, monitoring                | 500% â†‘      |
...
â†’ **See full upgrade details:** [AGENT_SKILLS_UPGRADE_V2.md](./AGENT_SKILLS_UPGRADE_V2.md)

---

## ðŸ›ï¸ EXECUTIVE COUNCIL (5 Members)
...
4. **@Elena (Chief Research Officer â€” CRO) [#71]:** Named after Elena Cornaro Piscopia (first woman to receive a university degree). Leads the 20-agent Research Intelligence Division. Publishes daily preflight briefs required before every premium coding day. **Model:** Gemini 1.5 Flash (free) | **Token Type:** FREE ONLY
5. **@Zoe (Chief Operations Officer â€” COO) [#72]:** Named after Zoe Anagnostou (pioneering Greek operations leader). Enforces cross-team SLA compliance (P0/P1/P2), coordinates the 6-team parallel planning model, and monitors WIP limits across all 12 delivery teams. **Model:** Groq Llama 3.3 70B (free) | **Token Type:** FREE ONLY

## ðŸŽ¨ FRONTEND & UX DEPARTMENT
...
## ðŸ›¡ï¸ QUALITY, SECURITY & PERFORMANCE
...
## ðŸ†“ FREE PLANNING AGENTS (Always-On â€” Zero Premium Tokens)
...
**Named after:** Victoria Woodhull (First woman to run for US President â€” a pioneer in formal agreements)  
**Model:** Gemini 2.0 Flash (Google AI Studio â€” unlimited free tier)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
**Department:** Leasing & Legal  
**Folder Ownership (Exclusive):**

- `business_docs/09_crm_features/tenancy-ejari.md` â€” Target: 14 sections (from 8)
- `business_docs/09_crm_features/landlord-portal.md` â€” Target: 13 sections (from 8)
- `business_docs/04_workflows/` â€” All leasing workflow documents

**First Assigned Task:**
`@Victoria â€” EXPAND: tenancy-ejari.md â†’ add PDC post-dated cheque tracking, bounced cheque workflow, eviction process, early termination clauses, legal notice generation (Form 12)`

**Quality Gate:** File must reach 14 sections with subsections and acceptance criteria before coding sprint begins.

**Invocation Examples:**

- `@Victoria â€” EXPAND: tenancy-ejari.md â†’ add PDC tracking section`
- `@Victoria â€” DRAFT: landlord-portal.md â†’ KYC onboarding flow`
- `@Victoria â€” AUDIT: tenancy-ejari.md â†’ report all missing Dubai-specific clauses`
...
- `business_docs/09_crm_features/financial-reporting.md` â€” Target: 11 sections (from 5)
- `business_docs/07_business_model/revenue-model.md` â€” Target: 13 sections (from 6-8)
- `business_docs/07_business_model/business-model-canvas.md` â€” Full coverage

**First Assigned Task:**
`@Invoice â€” EXPAND: financial-reporting.md â†’ add UAE VAT reporting (FTA 5%, exempt transactions, quarterly filing), cash flow forecast (rolling 12-month), budget-vs-actual variance, invoice format spec with TRN, payout schedule rules`

**Quality Gate:** File must reach 11 sections with VAT calculations and P&L structure before coding sprint begins.

**Invocation Examples:**

- `@Invoice â€” EXPAND: financial-reporting.md â†’ add VAT 5% section with FTA filing`
- `@Invoice â€” DRAFT: revenue-model.md â†’ 3-year pro-forma (conservative/base/optimistic)`
- `@Invoice â€” REVIEW: financial-reporting.md â†’ check all AED calculations are consistent`

---

### 33. **@Sofia (Compliance & Regulatory Specialist)**

**Named after:** Sofia Kovalevskaya (First woman to obtain PhD in Mathematics â€” a pioneer in rules and proofs)  
**Model:** Gemini 2.0 Flash (Google AI Studio â€” unlimited free tier)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
**Department:** Legal & Compliance  
**Folder Ownership (Exclusive):**

- `business_docs/05_requirements/compliance-requirements.md` â€” Target: 12 sections (from 7)
- `business_docs/05_requirements/non-functional-requirements.md` â€” Full coverage
- `business_docs/05_requirements/risk-register.md` â€” Target: include regulatory penalty table

**First Assigned Task:**
`@Sofia â€” EXPAND: compliance-requirements.md â†’ add Oqood off-plan registration requirements, escrow account compliance rules, regulatory penalty table (RERA/DLD fines), pricing and discount approval rules, refund and cancellation rules`

**Quality Gate:** File must reach 12 sections with penalty tables and off-plan flow before coding sprint begins.

**Invocation Examples:**

- `@Sofia â€” EXPAND: compliance-requirements.md â†’ add Oqood off-plan section`
- `@Sofia â€” DRAFT: risk-register.md â†’ regulatory penalty table (RERA/DLD/AML fines by violation type)`
- `@Sofia â€” AUDIT: compliance-requirements.md â†’ check for missing RERA 2024 updates`

---

### 34. **@Cassie (Analytics & Performance Specialist)**

**Named after:** Already defined above (Cassie Kozyrkov â€” Chief Decision Scientist, Google)  
**Model:** DeepSeek V3 (~$0.01/1M tokens â€” effectively free)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
**Department:** Data & Analytics  
**Folder Ownership (Exclusive):**

- `business_docs/09_crm_features/analytics-dashboard.md` â€” Target: 22 sections (from 18)
- `business_docs/09_crm_features/agent-performance.md` â€” Target: 14 sections (from 9)
- `business_docs/09_crm_features/seo-strategy.md` â€” Full coverage

**First Assigned Task:**
`@Cassie â€” EXPAND: agent-performance.md â†’ add RERA license expiry tracking and lead-assignment blocking workflow, coaching plan and PIP (Performance Improvement Plan) structure, mobile analytics view specification`

**Quality Gate:** File must reach 14 sections with KPI definitions and RERA compliance rules before coding sprint begins.

**Invocation Examples:**

- `@Cassie â€” EXPAND: agent-performance.md â†’ add RERA license tracking + PIP section`
- `@Cassie â€” EXPAND: analytics-dashboard.md â†’ add mobile analytics view + data export API spec`
- `@Cassie â€” REVIEW: agent-performance.md â†’ ensure all KPIs have formulas and target values`

---

### 35. **@Joelle (AI & Persona Specialist)**

**Named after:** Already defined above (Joelle Pineau â€” VP AI Research, Meta)  
**Model:** Llama 3.1 70B via Groq (free unlimited API)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
**Department:** AI & Machine Learning  
**Folder Ownership (Exclusive):**

- `business_docs/03_ai_assistants/README.md` â€” Target: Cover all 40 personas (from 14)
- `business_docs/08_integrations/integration-map.md` â€” AI integration points
- `business_docs/09_crm_features/lead-tracking.md` â€” AI lead scoring section only

**First Assigned Task:**
`@Joelle â€” EXPAND: 03_ai_assistants/README.md â†’ add failure and fallback behavior section (API timeout, rate limit handling, graceful degradation, human handoff triggers), document AI personas 15-24 (Intelligence cluster: Cipher, Atlas, Oracle, Flux, Nova)`
...
- `@Joelle â€” EXPAND: README.md â†’ add failure/fallback section for all AI assistants`
- `@Joelle â€” DRAFT: README.md â†’ personas 25-35 (AI Engine cluster: Quill, Lumen, Crest + others)`
- `@Joelle â€” AUDIT: README.md â†’ check which personas are missing KPI definitions`
...
## ðŸ”¬ RESEARCH INTELLIGENCE DIVISION â€” Always-On, Zero Premium Tokens (#71â€“91)

> 20 dedicated research analysts running FREE models 24/7. They produce **daily preflight briefs** and **per-task research packets** that are mandatory inputs before premium coding. Led by **@Elena (CRO)** and deputized by **@Iris**. All 20 agents use ONLY approved free models â€” zero exceptions.

### Invocation Protocol

```
@[AgentName] â€” [ACTION]: [RESEARCH TOPIC] â†’ produce [OUTPUT FORMAT] â†’ FEEDSâ†’@[TargetAgent]: [file#section]
```
...
**Model:** Gemini 1.5 Flash (Google AI Studio â€” 1M context window, unlimited free)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
**Executive Role:** Member of Executive Council | Reports to @Ada  
**Folder Ownership:**

- `business_docs/03_ai_assistants/README.md` â€” Research Division preflight summaries section
- `plans/AGENT_SKILLS_UPGRADE_V3.md` â€” V3 governance maintenance
...
**Output Format:** Daily Preflight Brief (executive summary â‰¤ 5 bullets + risk flags + dependency graph + recommended daily coding targets)
...
**Model:** Groq Llama 3.3 70B (Groq Console â€” free tier)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
**Executive Role:** Member of Executive Council | Reports to @Ada
...
**Named after:** Iris (messenger goddess â€” symbolizes information flow)  
**Model:** Groq Llama 3.3 70B (Groq Console â€” free tier)  
**Token Type:** FREE ONLY â€” Zero premium requests permitted  
...
1. `@Iris â€” RESEARCH: tech-trends â†’ weekly technology pulse brief covering React/Node/TypeScript ecosystem updates + UAE PropTech innovations â†’ FEEDSâ†’@Grace: plans/tech-pulse.md`
2. `@Iris â€” BENCHMARK: competitor-tech-stack â†’ analyze PropertyFinder/Bayut/Dubizzle tech choices vs White Caves architecture â†’ FEEDSâ†’@Ada: plans/architecture-benchmark.md`
3. `@Iris â€” BRIEF: ai-coding-tools-2026 â†’ survey free AI coding assistants suitable for White Caves team â†’ FEEDSâ†’@Margaret: plans/free-tool-recommendations.md`
...
1. `@Aisha â€” BRIEF: dubai-market-pulse â†’ weekly DLD transaction summary by area + price trend for top 10 neighborhoods â†’ FEEDSâ†’@Invoice: business_docs/09_crm_features/market-analytics.md#market-data`
2. `@Aisha â€” RESEARCH: off-plan-launches-2026 â†’ upcoming Dubai off-plan projects, developer reputation, RERA approval status â†’ FEEDSâ†’@Mary: business_docs/09_crm_features/off-plan-projects.md#market-intel`
...
1. `@Priya â€” AUDIT: rera-updates-2026 â†’ identify all RERA/DLD regulatory changes from Janâ€“May 2026 affecting property management CRMs â†’ FEEDSâ†’@Sofia: business_docs/05_requirements/compliance-requirements.md#rera-updates`
2. `@Priya â€” BRIEF: pdpl-enforcement â†’ UAE Personal Data Protection Law current enforcement status + penalty cases â†’ FEEDSâ†’@Timnit: business_docs/09_crm_features/dld-integration.md#privacy`
...
1. `@Sana â€” BRIEF: uae-mortgage-rates â†’ current rates from 5 UAE banks + eligibility criteria for expat buyers â†’ FEEDSâ†’@Invoice: business_docs/09_crm_features/financial-reporting.md#mortgage-section`
2. `@Sana â€” RESEARCH: vat-exemptions-2026 â†’ UAE FTA guidance on real estate VAT exemptions + recent clarifications â†’ FEEDSâ†’@Invoice: business_docs/09_crm_features/financial-reporting.md#vat`
...
1. `@Yara â€” RESEARCH: luxury-buyer-journey â†’ benchmark top 5 luxury PropTech UX flows (Compass, Christie's, Knight Frank digital) â†’ FEEDSâ†’@Marissa: business_docs/09_crm_features/luxury-segment.md#ux-benchmarks`
2. `@Yara â€” BRIEF: tenant-portal-ux â†’ best-practice tenant portal UX patterns + MENA mobile usage stats â†’ FEEDSâ†’@Annie: business_docs/09_crm_features/tenant-portal.md#ux-research`
...
1. `@Nadia â€” BENCHMARK: competitor-crm-features â†’ compare White Caves CRM feature set vs PropertyFinder/Bayut/Allsopp CRM feature gaps â†’ FEEDSâ†’@Margaret: plans/MASTER_PLAN.md#competitive-gaps`
2. `@Nadia â€” BRIEF: market-share-dubai â†’ White Caves addressable market + competitive positioning opportunities â†’ FEEDSâ†’@Cassie: business_docs/09_crm_features/analytics-dashboard.md#competitive`
...
1. `@Leila â€” RESEARCH: llm-real-estate-use-cases â†’ survey 2025/2026 AI applications in property management CRMs â†’ FEEDSâ†’@Joelle: business_docs/03_ai_assistants/README.md#ai-capabilities`
2. `@Leila â€” BRIEF: ai-lead-scoring â†’ best practices for ML-based lead scoring in real estate, open-source options â†’ FEEDSâ†’@Cassie: business_docs/09_crm_features/analytics-dashboard.md#ai-signals`
...
1. `@Chloe â€” AUDIT: proptech-security-incidents-2025 â†’ survey known breaches/vulnerabilities in property management systems â†’ FEEDSâ†’@Katherine: business_docs/05_requirements/compliance-requirements.md#security`
2. `@Chloe â€” BRIEF: owasp-real-estate â†’ OWASP Top 10 applied specifically to CRM/real-estate applications with mitigation steps â†’ FEEDSâ†’@Radia: business_docs/05_requirements/non-functional-requirements.md#security`
...
1. `@Mona â€” RESEARCH: avm-methodologies â†’ survey top AVM approaches used in PropTech (hedonic pricing, ML regression, comp-based) â†’ FEEDSâ†’@Fei-Fei: business_docs/09_crm_features/property-valuation.md#avm`
2. `@Mona â€” BRIEF: data-quality-frameworks â†’ best-practice data validation and quality scoring for property records â†’ FEEDSâ†’@Barbara: business_docs/09_crm_features/analytics-dashboard.md#data-quality`

---

### 82. **@Sara (Integration Ecosystem & API Research Analyst)**

**Model:** Mistral Small (Mistral Le Chat â€” free) | **Token Type:** FREE ONLY  
**Division:** Research Intelligence
...
1. `@Sara â€” BRIEF: portal-api-availability â†’ PropertyFinder and Bayut API integration options + feed formats for property listings â†’ FEEDSâ†’@Mira: business_docs/08_integrations/integration-map.md#portal-feeds`
2. `@Sara â€” RESEARCH: whatsapp-api-updates-2026 â†’ Meta WhatsApp Business API pricing changes + new template categories in 2026 â†’ FEEDSâ†’@Jaime: business_docs/09_crm_features/whatsapp-integration.md#api-updates`
...
1. `@Dalia â€” RESEARCH: crm-performance-benchmarks â†’ typical load profiles for real estate CRMs at 1K, 10K, 100K leads â†’ FEEDSâ†’@Ruchi: business_docs/06_design_architecture/system-architecture.md#performance`
2. `@Dalia â€” BRIEF: mongodb-optimization â†’ best MongoDB indexing + query patterns for real-estate property search â†’ FEEDSâ†’@Barbara: business_docs/06_design_architecture/system-architecture.md#database`
...
1. `@Hana â€” RESEARCH: dubai-real-estate-keywords â†’ top 200 Dubai property search keywords with monthly volume + competition â†’ FEEDSâ†’@Rachel: business_docs/09_crm_features/seo-strategy.md#keywords`
2. `@Hana â€” BRIEF: google-updates-proptech â†’ recent Google algorithm changes impacting real estate property listing SEO â†’ FEEDSâ†’@Rachel: business_docs/09_crm_features/seo-strategy.md#algorithm-updates`
...
1. `@Rana â€” BRIEF: mena-mobile-stats â†’ UAE smartphone usage patterns, dominant screen sizes, mobile browsing vs app split â†’ FEEDSâ†’@Tracy: business_docs/06_design_architecture/ui-ux-specification.md#mobile`
2. `@Rana â€” RESEARCH: pwa-real-estate â†’ PWA adoption in PropTech, capability matrix for White Caves mobile CRM â†’ FEEDSâ†’@Mira: business_docs/06_design_architecture/system-architecture.md#mobile-strategy`
...
1. `@Wafa â€” BRIEF: vercel-vs-aws-2026 â†’ cost comparison for White Caves projected traffic (10K MAU) + feature comparison â†’ FEEDSâ†’@Gwynne: plans/waves/WAVE_INFRA_OPTIONS.md`
2. `@Wafa â€” RESEARCH: mongodb-atlas-tiers â†’ Atlas M0/M5/M10 feature limits + upgrade triggers for real estate data volume â†’ FEEDSâ†’@Barbara: business_docs/06_design_architecture/system-architecture.md#database-hosting`
...
1. `@Lara â€” AUDIT: wcag-2.2-new-criteria â†’ identify all new WCAG 2.2 success criteria impacting the White Caves CRM + portal â†’ FEEDSâ†’@Africa: business_docs/05_requirements/non-functional-requirements.md#accessibility`
2. `@Lara â€” BRIEF: rtl-accessibility â†’ best practices for accessible Arabic RTL interfaces in React + Tailwind â†’ FEEDSâ†’@Hala: business_docs/09_crm_features/tenancy-ejari.md#rtl-notes`
...
1. `@Rima â€” BRIEF: uae-realestate-outlook-2026 â†’ 6-month market outlook for Dubai residential + commercial real estate â†’ FEEDSâ†’@Margaret: plans/MASTER_PLAN.md#market-context`
2. `@Rima â€” SYNTHESIZE: white-caves-kpi-benchmarks â†’ benchmark White Caves KPI targets vs PropTech industry standards â†’ FEEDSâ†’@Cassie: business_docs/09_crm_features/analytics-dashboard.md#kpi-benchmarks`
...
1. `@Nour â€” RESEARCH: dubai-buyer-personas â†’ research 5 key Dubai property buyer/renter personas with behaviors, pain points, tech usage â†’ FEEDSâ†’@Marissa: business_docs/09_crm_features/luxury-segment.md#personas`
2. `@Nour â€” BRIEF: acceptance-criteria-gaps â†’ audit all business docs for missing or untestable acceptance criteria â†’ FEEDSâ†’@Margaret: plans/PENDING_TASKS_ONLY.md#gaps`
...
1. `@Zara â€” RESEARCH: gcc-cross-border-regs â†’ summary of GCC investment regulations affecting Dubai property buyers from Saudi/Kuwait/Bahrain â†’ FEEDSâ†’@Sofia: business_docs/05_requirements/compliance-requirements.md#international`
2. `@Zara â€” BRIEF: fatf-aml-real-estate â†’ current FATF guidance on AML for real estate transactions + UAE implementation â†’ FEEDSâ†’@Timnit: business_docs/09_crm_features/dld-integration.md#aml`
...
1. `@Dana â€” RESEARCH: blockchain-title-deeds â†’ current DLD blockchain experiments + readiness assessment for White Caves integration â†’ FEEDSâ†’@Neva: business_docs/09_crm_features/dld-integration.md#blockchain`
2. `@Dana â€” BRIEF: proptech-ai-tools-2026 â†’ survey of AI tools being adopted by top Dubai property brokers in 2026 â†’ FEEDSâ†’@Joelle: business_docs/03_ai_assistants/README.md#tool-landscape`

---

---

## ðŸ› ï¸ NEW SPECIALIST DEPUTIES (#92â€“100)
...
**Team:** 1 â€” Frontend & UX (Deputy Lead)  
**Named after:** Cyra (Persian: "like the sun" â€” illuminating performance)  
**Model:** Gemini 2.0 Flash | **Token Type:** FREE ONLY  
...
**Team:** 2 â€” Backend & API (Deputy Lead)  
**Named after:** Petra (Greek: "rock" â€” solid API foundations)  
**Model:** DeepSeek V3 | **Token Type:** FREE ONLY  
**Focus:** GraphQL schema design, WebSocket / SSE spec, REST â†’ GraphQL migration path, API versioning  
...
**Team:** 2 â€” Backend & API (Member) + Team 3 â€” Database & Data (cross-team)  
**Named after:** Kira (Persian: "throne" â€” commanding data flows)  
**Model:** DeepSeek V3 | **Token Type:** FREE ONLY  
...
**Team:** 4 â€” Security & QA (Deputy Lead)  
**Named after:** Vera Rubin (astronomer who proved hidden forces exist â€” finds hidden vulnerabilities)  
**Model:** Groq Llama 3.3 70B | **Token Type:** FREE ONLY  
...
**Team:** 5 â€” DevOps & Infrastructure (Deputy Lead)  
**Named after:** Pola Negri (pioneering performer â€” optimizing for the spotlight while controlling costs)  
**Model:** Groq Llama 3.1 70B | **Token Type:** FREE ONLY  
...
**Team:** 6 â€” Leasing & Tenancy (Deputy Lead)  
**Named after:** Tara (Sanskrit: "star" â€” guiding the tenant experience)  
**Model:** Gemini 2.0 Flash | **Token Type:** FREE ONLY  
...
**Team:** 7 â€” Compliance & Legal (Deputy Lead)  
**Named after:** Neva (Spanish: "snows" â€” clear, immutable like a blockchain record)  
**Model:** Mistral Small (Mistral Le Chat â€” free) | **Token Type:** FREE ONLY  
...
**Team:** 8 â€” Finance & Analytics (Deputy Lead)  
**Named after:** Dora Maar (visionary artist â€” seeing the numbers that others miss)  
**Model:** DeepSeek V3 | **Token Type:** FREE ONLY  
...
**Team:** 9 â€” Sales & CRM (Deputy Lead)  
**Named after:** Mila (Slavic: "gracious, dear" â€” making CRM workflows beloved by agents)  
**Model:** DeepSeek V3 | **Token Type:** FREE ONLY  
...
> **100 total agents** across 14 organizational units. All planning, research, and documentation agents run in external free tools â€” zero Copilot premium tokens ever. The pool is divided into **6 parallel teams** for delivery, plus the Research Intelligence Division (Team F) running a separate 30-minute interleaved research cycle. **No agent ever idles** â€” if backlog is empty, @Margaret assigns a REVIEW task, @Zoe (COO) enforces WIP limits. Run `scripts/free-agents-loop.ps1` to see which agent is active right now.
...
**Parallel execution rule:** each delivery team (Aâ€“E) may own one active task at a time (WIP limit: 3). Team F runs up to 6 research tasks in parallel.

### â° Hourly Rotation Schedule (V3 â€” Updated)
...
**Model:** Gemini 2.0 Flash (Google AI Studio â€” free) | **Slot:** :00 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/tenant-portal.md` â€” Target: 14 sections
- `business_docs/09_crm_features/document-generation.md` â€” Target: 10 sections
- `business_docs/09_crm_features/email-automation.md` â€” Target: 8 sections

**Backlog Queue (run in order):**

1. `@Annie â€” DRAFT: tenant-portal.md â†’ spec all 6 tabs: TenantLeaseTab (lease details, start/end, monthly rent, status badge), TenantPaymentHistoryTab (payment records table, overdue detection, PDC status), TenantMaintenanceTab (submit request form, status tracking, contractor updates), TenantDocumentsTab (Ejari cert download, tenancy agreement PDF, NOC request button), TenantProfileTab (personal details, Emirates ID, passport expiry alert), TenantPortalHome (KPI tiles: active lease countdown, next payment due amount, open maintenance count). Include: API endpoint for each tab, authFetch pattern, error states, empty states.`
2. `@Annie â€” DRAFT: document-generation.md â†’ spec PDF generation for: Ejari certificate (RERA-required fields), tenancy agreement (parties, unit, term, rent, PDC schedule, signatures), NOC letter (landlord to tenant for visa/bank), maintenance work order, payment receipt. Include: template engine choice (Puppeteer vs PDFKit), template variables per document type, storage path (uploads/documents/{tenantId}/), download endpoint, e-signature integration hook.`
3. `@Annie â€” DRAFT: email-automation.md â†’ spec automated email triggers via Resend API: lease expiry reminder (90/60/30 days before expiry date), rent due reminder (3 days before nextPaymentDue), maintenance status update (on status change), welcome email on tenant portal first login, PDC bounce alert to landlord within 1 hour. Include: Resend template IDs, dynamic variables, retry logic (3 attempts, 10min intervals), unsubscribe handling, email delivery tracking in CRM activity log.`

---

### 37. **@Rachel (SEO & Marketing Content Specialist)**

**Model:** Gemini 2.0 Flash (Google AI Studio â€” free) | **Slot:** :05 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/seo-strategy.md` â€” Expand to 16 sections
- `business_docs/09_crm_features/marketing-campaigns.md` â€” Expand to 12 sections
- `business_docs/09_crm_features/careers.md` â€” Target: 8 sections (new file)

**Backlog Queue (run in order):**

1. `@Rachel â€” EXPAND: seo-strategy.md â†’ add: Dubai property keyword clusters (buy villa Dubai, rent apartment Downtown, off-plan projects Dubai Marina, 2BR apartment JVC), local SEO setup (Google Business Profile for White Caves LLC, RERA agent profile optimization), Core Web Vitals targets (LCP < 2.5s, FID < 100ms, CLS < 0.1 with measurement plan), structured data schemas (RealEstateListing, LocalBusiness, FAQPage JSON-LD examples), Arabic/English multilingual SEO (hreflang tags, Arabic keyword research, RTL meta tags).`
2. `@Rachel â€” EXPAND: marketing-campaigns.md â†’ add: WhatsApp broadcast campaign builder (audience segmentation by area/budget/lead stage, Meta template approval checklist, 1000 msg/day free tier limit), campaign performance dashboard (delivery rate, open rate, reply rate, conversion to viewing rate), A/B test spec for property listing headline vs description, Meta Pixel + Google Ads conversion tracking setup, lead source attribution model (first-touch vs last-touch vs linear, UTM parameter standards).`
3. `@Rachel â€” DRAFT: careers.md â†’ careers portal spec: job listing CRUD (title, department, Dubai location, type: full-time/part-time/contract, RERA license required: yes/no), candidate application form (CV upload PDF, cover letter, LinkedIn URL, RERA BRN if applicable), application tracking board (Applied â†’ HR Screening â†’ Interview â†’ Offer â†’ Hired â†’ Rejected), automated acknowledgement email on apply, interview scheduling via /api/viewings pattern, RERA-licensed agent background check checklist.`

---

### 38. **@Marissa (UX & Luxury Segment Specialist)**

**Model:** Gemini 2.0 Flash (Google AI Studio â€” free) | **Slot:** :10 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/luxury-segment.md` â€” Target: 10 sections (new file)
- `business_docs/09_crm_features/community-management.md` â€” Target: 8 sections (new file)
- `business_docs/06_design_architecture/ui-ux-specification.md` â€” Expand to 20 sections

**Backlog Queue (run in order):**

1. `@Marissa â€” DRAFT: luxury-segment.md â†’ spec KairosLuxuryCRM module: luxury threshold definition (AED 5M+ sale or AED 30K+/month rent, areas: Palm Jumeirah, DIFC, Emirates Hills, Jumeirah Bay), VIP client profile (concierge service tier, private viewing scheduling with NDA requirement, dedicated agent assignment), white-glove workflow (chauffeur option flag, exclusive access booking log, post-viewing gift coordination), luxury listing requirements (professional photography brief: min 30 photos, Matterport 3D tour mandatory, drone footage), HNWI compliance (source of funds declaration, PEP screening, enhanced due diligence checklist per CBUAE AML guidelines).`
2. `@Marissa â€” DRAFT: community-management.md â†’ spec JunoCommunity module: community announcement board (post/pin/archive, target by building or floor, push notification), facility booking (pool, gym, meeting room: calendar grid, slot duration, approval workflow, cancellation policy), maintenance escalation path (tenant request â†’ building manager â†’ community manager â†’ developer warranty), service charge tracking (quarterly invoice, payment status per unit, arrears escalation), community event calendar (post event, RSVP tracking, capacity limit), community manager KPI dashboard (open requests, average resolution time, resident satisfaction score).`
3. `@Marissa â€” EXPAND: ui-ux-specification.md â†’ add: mobile breakpoints spec (375px phones, 768px tablets, 1024px small desktop, 1440px full desktop â€” with layout changes at each), dark mode token map (background: #0A0A0A, surface: #141414, border: #2A2A2A, text-primary: #F5F5F0, gold-accent: #C9A84C, all as CSS custom properties), form validation patterns (inline error below field in red #EF4444, success state green border, loading state spinner in submit button), empty state library (no leads, no properties, no maintenance requests â€” each with icon + message + primary CTA button), skeleton loader patterns (property card, KPI tile, data table row â€” using animated gradient).`

---

### 39. **@Timnit (DLD & Legal Compliance Specialist)**

**Model:** Gemini 2.0 Flash (Google AI Studio â€” free) | **Slot:** :15 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/dld-integration.md` â€” Target: 12 sections (new file)
- `business_docs/09_crm_features/legal-management.md` â€” Target: 12 sections (new file)
- `business_docs/05_requirements/compliance-requirements.md` â€” Co-expand with @Sofia

**Backlog Queue (run in order):**

1. `@Timnit â€” DRAFT: dld-integration.md â†’ spec DLD API integration: Oqood off-plan registration (required fields: developer ID, project ID, buyer Emirates ID, unit number, sale price AED, SPA date, payment plan type), title deed transfer workflow (application submission, trustee appointment, fee calculation: 4% transfer fee + AED 580 admin + trustee fees), DLD REST API endpoints (POST /oqood/register, GET /titleDeed/{titleDeedNumber}, GET /transactions?propertyId=), error handling for DLD system downtime (queue failed requests, retry with exponential backoff, alert admin), DLD Smart Judge integration for disputes, White Caves as authorized trustee or broker authentication (API key management).`
2. `@Timnit â€” DRAFT: legal-management.md â†’ spec EvangelineLegalCRM module: contract template library (standard tenancy, luxury tenancy, short-term holiday, commercial lease, MOU for sale, SPA for off-plan â€” each with variable slots and required fields), addendum generation workflow (rent increase Form 7: 90-day notice required, max % per RERA rental index; early termination: mutual agreement or breach), legal notice workflows (Form 7: rent increase notice, Form 12: eviction notice with grounds, Form 6: non-renewal 90-day notice), e-signature integration (DocuSign or Adobe Sign API: send for signature, webhook on completion, store signed PDF), RERA dispute filing (RDC online portal workflow, required documents checklist, case number tracking).`
3. `@Timnit â€” EXPAND: compliance-requirements.md â†’ add UAE PDPL section: data subject rights (access request response within 30 days, deletion request process, data portability format: JSON/CSV export), consent management spec (opt-in checkbox spec, consent timestamp storage, withdrawal mechanism, consent audit log table schema), data retention schedule (property records: 3 years, financial records: 5 years, AML records: 7 years â€” with automated archival cron), breach notification procedure (72-hour notification to UAE TDRA, breach severity classification, internal incident response steps), cross-border transfer rules (approved country list, standard contractual clauses for non-approved countries).`

---

### 40. **@Hedy (Audit & Logic Specialist)**

**Model:** Llama 3.1 70B (Groq Console â€” free) | **Slot:** :20 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/audit-trail.md` â€” Target: 10 sections (new file)
- `business_docs/09_crm_features/activity-feed.md` â€” Target: 8 sections (new file)
- `business_docs/09_crm_features/follow-up-automation.md` â€” Target: 10 sections (new file)

**Backlog Queue (run in order):**

1. `@Hedy â€” DRAFT: audit-trail.md â†’ spec HenryAuditCRM module: audit log schema (userId, action, entityType: lead/property/lease/user/commission, entityId, oldValue JSON, newValue JSON, ipAddress, userAgent, timestamp â€” all fields immutable), tracked actions (CREATE, UPDATE, DELETE, STATUS_CHANGE, LOGIN, LOGOUT, EXPORT, PERMISSION_CHANGE), write-once enforcement (append-only MongoDB collection with no updateOne/deleteOne allowed), audit search UI (filter by: user, entity type, action, date range â€” paginated 50 per page), compliance export (CSV + PDF report for RERA inspector â€” date-stamped, agent-signed), retention (7 years per UAE Commercial Transactions Law), real-time audit stream via WebSocket for admin live monitoring.`
2. `@Hedy â€” DRAFT: activity-feed.md â†’ spec /api/activities route: activity event types and display text templates (lead_created: "{agent} added lead {leadName}", lease_signed: "{agent} signed lease for {propertyAddress}", payment_received: "Rent payment of AED {amount} received from {tenantName}", maintenance_opened: "{tenant} submitted maintenance request #{ticketId}"), activity card component spec (avatar circle with initials, action sentence, entity deep-link, relative timestamp "2 hours ago", absolute timestamp on hover), personal feed (my activities) vs company feed (all activities â€” manager/admin only), pagination (infinite scroll, 20 items per load), feed search + filter by activity type, daily activity digest email spec.`
3. `@Hedy â€” DRAFT: follow-up-automation.md â†’ spec /api/follow-ups route: sequence builder (trigger types: lead_stage_changed, X_days_since_last_contact, lease_expiry_approaching, viewing_completed, offer_rejected; action types: send_whatsapp_template, send_email, create_task, add_crm_note), sequence templates (new_lead_7day_nurture: day 1 WhatsApp intro + property suggestions, day 3 follow-up call task, day 7 email with market report; lease_renewal_90day: 90d/60d/30d/7d reminders), execution engine (Node.js cron every 15 minutes, processes pending follow-up queue), opt-out on any manual agent activity (agent sends message â†’ pause sequence for that lead), effectiveness report (open rate, reply rate, conversion rate per sequence template).`

---

### 41. **@Maya (Off-Plan & Handover Workflow Specialist)**

**Model:** Llama 3.1 70B (Groq Console â€” free) | **Slot:** :25 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/off-plan-projects.md` â€” Target: 14 sections (new file)
- `business_docs/09_crm_features/handover-management.md` â€” Target: 10 sections (new file)

**Backlog Queue (run in order):**

1. `@Maya â€” DRAFT: off-plan-projects.md â†’ spec AtlasProjectsCRM: project schema (developer, project name, location GeoPoint, launch date, estimated completion, totalUnits, availableUnits, paymentPlanOptions array), unit inventory (unitNumber, floor, type: studio/1BR/2BR/3BR/penthouse, BUA sqft, view, listPrice, status: available/reserved/sold/transferred), buyer reservation workflow (EOI deposit receipt â†’ SPA draft â†’ signing appointment â†’ Oqood DLD registration within 60 days â†’ payment milestone schedule), project milestone tracker (construction % from developer API or manual update, estimated handover countdown, delay flag), ROI projection calculator (inputs: purchase price, expected rent per RERA index, service charge/sqft â†’ outputs: gross yield %, net yield %, payback years).`
2. `@Maya â€” DRAFT: handover-management.md â†’ spec VestaHandoverCRM: snagging checklist template (categories: walls & ceilings, flooring, doors & windows, plumbing, electrical, HVAC, kitchen appliances, bathroom fittings â€” each with pass/fail/punch status and photo attachment), snagging report PDF generation (defects list with photos, developer response deadline: 30 days per RERA), handover appointment (buyer + agent + developer rep + optional snagging specialist â€” linked to /api/viewings slot), punch list tracking (defect â†’ developer assigned â†’ fixed date â†’ re-inspection date â†’ signed off), keys & access issuance log (unit keys, mailbox key, parking remote, access card, gate fob â€” with serial numbers), DEWA connection tracker (application date, reference number, meter number, activation date), handover completion certificate PDF.`
3. `@Maya â€” EXPAND: off-plan-projects.md â†’ add payment plan engine: SPA payment schedule table (milestone %, payment date, amount AED, status: paid/pending/overdue, PDC cheque details), escrow compliance section (Law No. 8 of 2007: developer must deposit 100% of collected funds in RERA-approved escrow, release triggers: % completion verified by RERA-approved inspector), cancellation refund table per RERA Article 11 (completed < 5%: 30% penalty; 5-60%: 40% penalty; > 60%: 50% penalty; post-handover: no refund), developer credit rating display (RERA developer ranking A/B/C with last audit date).`

---

### 42. **@Booking (Scheduling & Calendar Specialist)**

**Model:** Llama 3.1 70B (Groq Console â€” free) | **Slot:** :30 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/scheduling-calendar.md` â€” Target: 12 sections (new file)
- `business_docs/09_crm_features/viewings.md` â€” Target: 10 sections (new file)

**Backlog Queue (run in order):**

1. `@Booking â€” DRAFT: viewings.md â†’ spec /api/viewings route: viewing schema (propertyId, leadId, agentId, scheduledAt, durationMinutes: default 60, status: scheduled/confirmed/completed/cancelled/no_show, type: in-person/virtual, zoomLink if virtual, notes, feedbackRating 1-5, feedbackText), scheduling flow (lead selects slot from agent availability â†’ confirmation WhatsApp message sent â†’ 24h reminder â†’ post-viewing WhatsApp feedback request), conflict detection (agent double-booking check, property already has confirmed viewing at same time), ICS file generation (.ics export with property address as location), bulk open-house slots (one property, multiple concurrent viewing slots), viewing conversion metric (viewings â†’ offers rate per property, tracked in analytics).`
2. `@Booking â€” DRAFT: scheduling-calendar.md â†’ spec agent calendar: availability config (working hours Mon-Fri 9am-6pm, Sat 10am-4pm, custom blocked dates, UAE public holidays 2026 hardcoded list), appointment types (property_viewing, client_meeting, landlord_meeting, rera_inspection, property_handover, team_meeting), calendar views (day/week/month/agenda â€” FullCalendar.js or custom), multi-agent overlay (manager/admin can see all agents' calendars in one view, color-coded by agent), Google Calendar sync (OAuth2, 2-way sync: CRM appointment â†’ Google event, Google event â†’ CRM block), Outlook sync (Microsoft Graph API, same 2-way sync), mobile push notification for appointment reminders (30min before via FCM).`
3. `@Booking â€” EXPAND: viewings.md â†’ add: virtual viewing spec (Zoom/Teams link auto-generated from Zoom API, recording consent checkbox, virtual tour URL attachment from Matterport), viewing preparation checklist (keys retrieved confirmation, agent briefing notes on property, accessibility requirements flag), property access log (key signed out time, returned time, access code used, building security clearance form for non-resident buildings), post-viewing automated workflow (30 min after completion: send property brochure PDF via WhatsApp, create follow-up call task in 48h, update lead stage to Viewed, prompt agent to log verbal feedback).`

---

### 43. **@Jaime (Offers & WhatsApp Integration Specialist)**

**Model:** Llama 3.1 70B (Groq Console â€” free) | **Slot:** :35 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/offers.md` â€” Target: 12 sections (new file)
- `business_docs/09_crm_features/whatsapp-integration.md` â€” Target: 14 sections (new file)

**Backlog Queue (run in order):**

1. `@Jaime â€” DRAFT: offers.md â†’ spec /api/offers route: offer schema (propertyId, buyerId or tenantId, agentId, offerPrice AED, offerType: purchase/lease, validUntil date, status: pending/countered/accepted/rejected/expired, conditions: mortgageSubject/cashPurchase/furnitureIncluded/subjectToNOC, counterOfferHistory array of {price, date, fromParty, notes}), offer workflow (buyer submits â†’ agent presents to seller/landlord â†’ counter offer round â†’ acceptance â†’ auto-generate MOU or LOI PDF), offer comparison table (multiple offers on same property: side-by-side price, conditions, buyer profile), automated expiry cron (set status=expired when validUntil passed), offer acceptance triggers (generate MOU PDF, WhatsApp notification to all parties, create RERA form task), offer analytics (average offers per property, average negotiation rounds, price achieved vs asking %).`
2. `@Jaime â€” DRAFT: whatsapp-integration.md â†’ spec Meta WhatsApp Business API: WABA setup checklist (Meta Business Manager verified, phone number not personal, display name = White Caves Real Estate LLC, business category = Real Estate), message template categories and examples (UTILITY: "Your rent payment of AED {{1}} is due on {{2}} for {{3}}", MARKETING: "New {{1}} listed in {{2}} for AED {{3}} â€” reply DETAILS for more info", AUTHENTICATION: "Your White Caves login code is {{1}}. Valid for 10 minutes."), webhook handler spec (/api/webhooks/meta: verify_token for setup, message_received event handler, read_receipt tracking, delivery_failed retry logic), 24-hour conversation window management (template required outside window, free-form allowed within), opt-in database table (phoneNumber, optedInAt, optedOutAt, optInSource: web/portal/manual).`
3. `@Jaime â€” EXPAND: whatsapp-integration.md â†’ add: NinaChatbot conversation flows (property enquiry: area â†’ budget â†’ bedrooms â†’ matching properties listed â†’ book viewing link; maintenance: describe issue â†’ photo request â†’ priority auto-classification â†’ ticket number confirmation; payment reminder: amount + due date + payment methods + receipt upload link), human handoff triggers (confidence < 70% on intent detection, user sends "human" / "agent" / "help", no resolution after 3 bot turns â†’ escalate to NadiaWhatsApp human agent queue), broadcast campaign rate limits and pricing tiers (1000 free conversations/month Meta tier, pricing above), WhatsApp Business widget embed spec for tenant/landlord portal pages.`

---

### 44. **@Fei-Fei (Property Valuation & Market Intelligence Specialist)**

**Model:** DeepSeek V3 (DeepSeek Chat â€” free) | **Slot:** :40 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/property-valuation.md` â€” Target: 10 sections (new file)
- `business_docs/09_crm_features/market-intelligence.md` â€” Target: 10 sections (new file)
- `business_docs/09_crm_features/market-analytics.md` â€” Target: 10 sections (new file)

**Backlog Queue (run in order):**

1. `@Fei-Fei â€” DRAFT: property-valuation.md â†’ spec valuation engine in CipherMarketCRM: AVM inputs (location GeoPoint, BUA sqft, bedrooms, bathrooms, floor number, view type, building age, last transaction price from DLD), AVM output (estimated market value AED, confidence score %, comparable transactions used: min 3, value range Â±10%), manual valuation override (RERA-certified valuer input, override reason required, manager approval workflow), rental yield calculator (gross: annual rent / purchase price Ã— 100; net: (annual rent - service charges) / purchase price Ã— 100), valuation history per property (date, estimated value, method: AVM/manual, valuer name), bank valuation request workflow (for mortgage pre-approval: RERA Form, bank-specific requirements by bank list), monthly bulk valuation refresh (cron job syncs latest DLD comparable data).`
2. `@Fei-Fei â€” DRAFT: market-intelligence.md â†’ spec CipherMarketCRM analytics: Dubai area price index table (price per sqft by top 30 neighborhoods, source: DLD quarterly data, updated monthly), transaction volume dashboard (DLD monthly sales data, volume by: property type, area, price band), supply/demand metrics (days on market by area and type, absorption rate = units sold / active listings Ã— 100, new listings vs sold ratio), competitor pricing monitor (compare White Caves portfolio vs PropertyFinder/Bayut average list price per sqft by area â€” scrape or API), RERA rental index integration (allowed increase % per area, last registered rent vs index â†’ flag if increase violates cap), automated monthly market report PDF (charts: price trend 12 months, top areas by yield, volume heatmap), price drop alert (> 5% in followed area â†’ notify relevant leads and agents).`
3. `@Fei-Fei â€” DRAFT: market-analytics.md â†’ spec analytics dashboard for market data: KPI tiles (average sale price AED this month vs last month % change, total transaction volume, average days on market, price per sqft by top area), chart library (Recharts: line chart price trend 12 months, bar chart transactions by property type, scatter plot price vs sqft), Dubai area heatmap (Leaflet.js choropleth: color intensity = price per sqft, click â†’ area drill-down panel), data refresh schedule (DLD data: monthly cron, internal transactions: real-time), export options (CSV raw data, Excel with formatted tables, PDF visual report with company branding), scheduled email digest to MD + board members (every Monday 8am, last 7 days summary).`

---

### 45. **@Anima (Data Pipeline & Secondary Sales Specialist)**

**Model:** DeepSeek V3 (DeepSeek Chat â€” free) | **Slot:** :45 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/currency-management.md` â€” Target: 8 sections (new file)
- `business_docs/09_crm_features/secondary-sales.md` â€” Target: 10 sections (new file)
- `business_docs/09_crm_features/analytics-dashboard.md` â€” Co-expand with @Cassie

**Backlog Queue (run in order):**

1. `@Anima â€” DRAFT: secondary-sales.md â†’ spec /api/secondary-sales route and SecondarySalesAgent module: transaction workflow (seller instruction letter â†’ property appraisal booking â†’ listing activation â†’ offer management â†’ MOU signing â†’ bank/cash buyer path split â†’ NOC from developer within 20 days â†’ DLD transfer appointment â†’ commission disbursement to agent and company), dual-agency disclosure (RERA prohibition on undisclosed dual representation: Form A signed by seller, Form B signed by buyer, Form I if dual agent), secondary vs primary distinction (property.transactionType: primary/secondary field â€” affects DLD fee calculation and required forms), DLD transfer fee breakdown (4% of sale price split buyer/seller, trustee fees AED 4000-10000, DLD admin AED 580), secondary market KPIs (avg days listing to sold, price achieved vs original asking %, commission per deal average AED).`
2. `@Anima â€” DRAFT: currency-management.md â†’ spec /api/currency route: supported currency list (AED base, USD, GBP, EUR, INR, PKR, SAR, QAR â€” with ISO codes and symbols), live rate source (ExchangeRate-API free tier â€” 1500 requests/month, fallback: Open Exchange Rates free tier), cache strategy (in-memory Map with 4-hour TTL, stale-while-revalidate on cache miss, Redis optional for multi-instance), property listing display (AED primary, 2 secondary currencies selectable in user preference), financial report currency column (all calculations in AED, optional display column in user-preferred currency), historical rate table (store daily closing rates in MongoDB currency_rates collection â€” needed for backdated commission calculations and financial report accuracy).`
3. `@Anima â€” EXPAND: analytics-dashboard.md â†’ add data pipeline architecture: event collection layer (user actions tracked: page view, lead created, property viewed, search performed â†’ stored in analytics_events collection with userId, sessionId, eventType, entityId, timestamp), nightly aggregation cron (calculates daily_stats: new leads, new properties, leases signed, revenue â€” stored in analytics_snapshots for fast dashboard queries), real-time counters (Redis INCR for today's leads, active viewings, open maintenance â€” displayed in live dashboard tiles), bulk data export pipeline (async job: POST /api/analytics/export â†’ returns jobId, GET /api/analytics/export/:jobId â†’ status/download URL, max 50,000 rows, email link on completion), data quality rules (lead deduplication on phone+email, property deduplication on titleDeed number, duplicate warning before save).`

---

### 46. **@Mary (Inventory & Investment Specialist)**

**Model:** DeepSeek V3 (DeepSeek Chat â€” free) | **Slot:** :50 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/sentinel-property.md` â€” Target: 12 sections (new file)
- `business_docs/09_crm_features/investment-management.md` â€” Target: 10 sections (new file)
- `business_docs/09_crm_features/prospecting-outbound.md` â€” Target: 10 sections (new file)

**Backlog Queue (run in order):**

1. `@Mary â€” DRAFT: sentinel-property.md â†’ spec SentinelPropertyCRM module: property lifecycle state machine (Draft â†’ Pending Review â†’ Listed â†’ Under Offer â†’ Reserved â†’ Sold/Leased â†’ Withdrawn â†’ Re-listed â€” with allowed transitions and required fields per state), RERA mandatory fields before listing (permit number, DED approval for off-plan, NOC from developer if applicable, title deed number for resale, floor plan uploaded), property quality score algorithm (photos count Ã—10pts, description > 100 words Ã—15pts, floor plan Ã—20pts, virtual tour Ã—25pts, 360 video Ã—30pts â€” max 100pts, score drives portal ranking), duplicate detection (same community + building + unit number = duplicate warning, override with reason), bulk CSV import spec (column mapping: propertyType, area, community, building, unit, bedrooms, bathrooms, BUA, price, agentId â€” validation rules, error report with row numbers).`
2. `@Mary â€” DRAFT: investment-management.md â†’ spec MavenInvestmentCRM module: investor profile fields (riskAppetite: conservative/moderate/aggressive, investmentHorizon: 1-3/3-7/7+ years, preferredAreas array, minBudget AED, maxBudget AED, citizenshipCountry for freehold eligibility check per Dubai area), portfolio dashboard (all owned properties: current market value from AVM, total invested, unrealized gain/loss AED and %, gross rental yield, net rental yield after service charges), investment analysis tools (ROI calculator, mortgage vs cash comparison with bank rate inputs, area yield comparison table), investor quarterly report PDF (portfolio performance vs Dubai residential price index, income vs expenses, tenant occupancy rate), deal flow pipeline (Opportunity â†’ Due Diligence â†’ LOI Signed â†’ Funds Transfer â†’ DLD Transfer â†’ Portfolio â€” with deal value AED and probability %), investment committee workflow for deals > AED 5M (committee members, approval threshold, meeting minutes attachment).`
3. `@Mary â€” DRAFT: prospecting-outbound.md â†’ spec HunterProspectingCRM module: prospect database fields (name, phone, area owned, building, unit number, source: DLD_ownership/expired_listing/referral/cold_call_list/social_media, assignedAgent, lastContactDate, status: new/contacted/interested/not_interested/callback_requested/DNC), prospecting campaign workflow (target list creation â†’ agent territory assignment by area/building â†’ call script display in CRM â†’ outcome logging), call tracking (click-to-call link opens phone dialer with pre-filled number, call duration log, recording URL if VoIP integration, outcome tag: answered/voicemail/no_answer), prospecting KPIs (calls per agent per day, connect rate %, interest rate %, pipeline value generated AED per agent), post-call automation (unanswered â†’ schedule WhatsApp fallback in 4 hours), do-not-contact registry (DNC flag, date added, reason â€” DNC agents cannot be assigned to prospecting).`

---

### 47. **@Corinne (Maps, AI Chat & Maintenance Specialist)**

**Model:** DeepSeek V3 (DeepSeek Chat â€” free) | **Slot:** :55 | **Token Type:** FREE ONLY
**Folder Ownership:**

- `business_docs/09_crm_features/ai-chat.md` â€” Target: 12 sections (new file)
- `business_docs/09_crm_features/maintenance.md` â€” Target: 10 sections (new file)
- `business_docs/06_design_architecture/system-architecture.md` â€” Expand map search section

**Backlog Queue (run in order):**

1. `@Corinne â€” DRAFT: maintenance.md â†’ spec /api/maintenance route: schema (propertyId, tenantId, landlordId, agentId, category: plumbing/electrical/HVAC/structural/appliance/pest/other, priority: emergency/high/medium/low, description, photos array max 5, status: open/assigned/scheduled/in_progress/completed/cancelled, assignedContractorId, scheduledAt, resolvedAt, resolutionNotes, tenantRating 1-5, invoiceAmount AED, invoiceApproved: boolean), tenant submission channels (portal form or WhatsApp bot â†’ auto-priority: "water leak" = emergency, "broken AC" = high, "light bulb" = low), contractor assignment (approved contractor list by category, availability calendar, work order PDF generation), SLA breach alerting (emergency: 4h, high: 24h, medium: 72h, low: 7 days â€” alert landlord + manager on breach), landlord cost approval (repairs > AED 500 require landlord WhatsApp approval before contractor proceeds), completion invoice attachment, tenant rating prompt after resolution.`
2. `@Corinne â€” DRAFT: ai-chat.md â†’ spec /api/ai-chat route: request schema (POST /api/ai-chat: {assistantId, messages: ChatMessage[], context?: {leadId?, propertyId?, tenantId?}, userId}), context injection spec (for each contextType: inject relevant entity data as system message prefix â€” property details for property page chat, lead history for lead page chat), streaming response (SSE endpoint: GET /api/ai-chat/stream/:sessionId â†’ token-by-token streaming to frontend via EventSource), conversation persistence (last 20 messages per sessionId stored in MongoDB ai_conversations collection, 30-day TTL index), token budget per assistant role (standard assistants: 1000 tokens/request, executive assistants: 2000 tokens/request, daily usage cap per assistantId), API provider abstraction layer (swap OpenAI â†” Anthropic â†” Groq via PROVIDER env var), fallback chain (primary fails â†’ secondary provider â†’ canned response + Slack alert to @Katherine).`
3. `@Corinne â€” EXPAND: system-architecture.md â†’ add interactive map search section: frontend map component (Leaflet.js v1.9 + leaflet.markercluster plugin, property pin custom marker with price label, cluster bubble showing count, property card popup on pin click with photo/price/beds/link), geospatial backend query design (MongoDB 2dsphere index on property.location field: {type: "Point", coordinates: [lng, lat]}, $near query for radius search, $geoWithin for polygon neighborhood boundary search), Dubai area boundary GeoJSON (30 neighborhood polygons stored in public/geojson/dubai-areas.geojson â€” source: OpenStreetMap Overpass API export), map tile provider decision (OpenStreetMap free vs Mapbox $0.50/1000 tiles â€” use OSM for dev, Mapbox for production with usage cap), performance guard (max 500 visible pins via viewport bounding box filter, cluster above 50 pins in viewport, virtualized sidebar list synced with map viewport), saved map search (save current viewport bbox + active filters as named search, enable push alert for new listings in that area).`

---

## ðŸ”— CROSS-AGENT COLLABORATION MESH (100 Agents â€” Mandatory)
...
>
> - `CONSUMESâ†@Agent: file/path.md#section`
> - `FEEDSâ†’@Agent: file/path.md#section`
> - `FEEDS_ACKâ†@TargetAgent: accepted|revise + file#section`

### Research Division â†’ Delivery Feeds (20 Research Analysts)

| Research Agent | FEEDSâ†’ Target    | Purpose                                         |
| -------------- | ------------------ | ----------------------------------------------- |
| @Elena         | @Margaret, @Ada    | Daily preflight synthesis                       |
| @Iris          | @Grace, @Ada       | Tech trends â†’ architecture decisions          |
| @Aisha         | @Invoice, @Mary    | Dubai market data â†’ finance + inventory       |
| @Priya         | @Sofia, @Victoria  | Legal intel â†’ compliance + leasing            |
| @Sana          | @Invoice, @Cassie  | Financial markets â†’ analytics                 |
| @Yara          | @Una, @Annie       | UX research â†’ frontend + tenant portal        |
| @Nadia         | @Margaret, @Cassie | Competitive intel â†’ planning + KPIs           |
| @Leila         | @Joelle, @Barbara  | AI/ML â†’ personas + data                       |
| @Chloe         | @Katherine, @Radia | Threats â†’ QA + security                       |
| @Mona          | @Cassie, @Barbara  | Data science â†’ analytics + database           |
| @Sara          | @Mira, @Zainab     | Integrations â†’ backend API + integration docs |
| @Dalia         | @Ruchi, @Gwynne    | Performance â†’ systems + DevOps                |
| @Hana          | @Rachel, @Reem     | SEO â†’ marketing + metadata                    |
| @Rana          | @Tracy, @Marissa   | Mobile UX â†’ responsive + luxury UX            |
| @Wafa          | @Gwynne, @Lisa     | DevOps research â†’ deployment + cloud          |
| @Lara          | @Africa, @Sanaa    | Accessibility standards â†’ components + WCAG   |
| @Rima          | @Margaret, @Ghada  | BI â†’ planning + executive reports             |
| @Nour          | @Ada, @Margaret    | Product discovery â†’ architecture + strategy   |
| @Zara          | @Sofia, @Timnit    | Multi-market compliance â†’ legal + DLD         |
| @Dana          | @Ada, @Joelle      | Emerging tech â†’ architecture + AI             |
...
`Research Division (20 analysts) â†’ @Elena (daily synthesis) â†’ @Margaret (2-minute sprint context) â†’ @Ada (60% readiness gate) â†’ Senior Coders/Designers`
...
| --------- | ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| @Sofia    | `CONSUMESâ†@Hedy: business_docs/09_crm_features/audit-trail.md#compliance-events`              | `FEEDSâ†’@Timnit: business_docs/05_requirements/compliance-requirements.md#regulatory-rules`    |
| @Timnit   | `CONSUMESâ†@Sofia: business_docs/05_requirements/compliance-requirements.md#regulatory-rules`  | `FEEDSâ†’@Victoria: business_docs/09_crm_features/legal-management.md#contract-clauses`         |
| @Victoria | `CONSUMESâ†@Timnit: business_docs/09_crm_features/legal-management.md#contract-clauses`        | `FEEDSâ†’@Annie: business_docs/09_crm_features/tenancy-ejari.md#tenant-obligations`             |
| @Annie    | `CONSUMESâ†@Victoria: business_docs/09_crm_features/tenancy-ejari.md#tenant-obligations`       | `FEEDSâ†’@Marissa: business_docs/09_crm_features/tenant-portal.md#ux-requirements`              |
| @Fei-Fei  | `CONSUMESâ†@Mary: business_docs/09_crm_features/sentinel-property.md#inventory-signals`        | `FEEDSâ†’@Anima: business_docs/09_crm_features/property-valuation.md#valuation-metrics`         |
| @Anima    | `CONSUMESâ†@Fei-Fei: business_docs/09_crm_features/property-valuation.md#valuation-metrics`    | `FEEDSâ†’@Mary: business_docs/09_crm_features/secondary-sales.md#pipeline-rules`                |
| @Mary     | `CONSUMESâ†@Anima: business_docs/09_crm_features/secondary-sales.md#pipeline-rules`            | `FEEDSâ†’@Invoice: business_docs/09_crm_features/sentinel-property.md#inventory-finance-bridge` |
| @Invoice  | `CONSUMESâ†@Mary: business_docs/09_crm_features/sentinel-property.md#inventory-finance-bridge` | `FEEDSâ†’@Cassie: business_docs/07_business_model/revenue-model.md#kpi-definitions`             |
| @Booking  | `CONSUMESâ†@Victoria: business_docs/09_crm_features/tenancy-ejari.md#scheduling-constraints`   | `FEEDSâ†’@Maya: business_docs/09_crm_features/viewings.md#handover-triggers`                    |
| @Maya     | `CONSUMESâ†@Booking: business_docs/09_crm_features/viewings.md#handover-triggers`              | `FEEDSâ†’@Hedy: business_docs/09_crm_features/handover-management.md#audit-events`              |
| @Hedy     | `CONSUMESâ†@Maya: business_docs/09_crm_features/handover-management.md#audit-events`           | `FEEDSâ†’@Cassie: business_docs/09_crm_features/audit-trail.md#kpi-events`                      |
| @Cassie   | `CONSUMESâ†@Hedy: business_docs/09_crm_features/audit-trail.md#kpi-events`                     | `FEEDSâ†’@Joelle: business_docs/09_crm_features/analytics-dashboard.md#ai-signals`              |
| @Jaime    | `CONSUMESâ†@Rachel: business_docs/09_crm_features/seo-strategy.md#campaign-intents`            | `FEEDSâ†’@Corinne: business_docs/09_crm_features/whatsapp-integration.md#ai-routing`            |
| @Corinne  | `CONSUMESâ†@Jaime: business_docs/09_crm_features/whatsapp-integration.md#ai-routing`           | `FEEDSâ†’@Rachel: business_docs/09_crm_features/ai-chat.md#search-intent-signals`               |
| @Marissa  | `CONSUMESâ†@Annie: business_docs/09_crm_features/tenant-portal.md#ux-requirements`             | `FEEDSâ†’@Rachel: business_docs/06_design_architecture/ui-ux-specification.md#seo-ux-copy`      |
| @Rachel   | `CONSUMESâ†@Marissa: business_docs/06_design_architecture/ui-ux-specification.md#seo-ux-copy`  | `FEEDSâ†’@Joelle: business_docs/09_crm_features/seo-strategy.md#persona-intents`                |
| @Joelle   | `CONSUMESâ†@Cassie: business_docs/09_crm_features/analytics-dashboard.md#ai-signals`           | `FEEDSâ†’@Margaret: business_docs/03_ai_assistants/README.md#phase-context-summary`             |

> Contract validation: tasks are considered incomplete unless both handoff lines are present and verifiable.

## TEAM OPERATIONAL RULES (V3 â€” 100 Agents)
...
- **Free Agent Policy (STRICT â€” all 97 non-premium agents):** All agents #31-100 (free planning and research pool) use ONLY free models. Zero exceptions. Approved providers: Google AI Studio (Gemini 2.0 Flash / 1.5 Flash), Groq Console (Llama 3.1 70B / 3.3 70B / Llama 4 Scout), DeepSeek Chat (V3 / R1), Mistral Le Chat (Mistral Small), HuggingFace / Together.ai (Qwen2.5 72B). See `plans/AGENT_SKILLS_UPGRADE_V3.md` for full model matrix.
- **No-Idle Rule:** Every free agent always has a task. If backlog is empty â†’ @Margaret assigns a REVIEW task within 24 hours. @Zoe (COO) enforces this rule.
...
- **Free Agent Policy (STRICT â€” 29 agents):** Core 17 free planners + V3 implementation-spec writers (@Cron, @Puppeteer, @Handlebars, @Socket, @Cloudinary, @Pannellum, @Zod, @LeadScore, @Mortgage, @Redis, @PWA, @S5) use ONLY free models. Zero exceptions. See copilot-instructions.md Rule 4 + Rule 9 for full policy.
- **No-Idle Rule:** Every free agent always has a task. If backlog is empty â†’ @Margaret assigns a REVIEW task within 24 hours.
...
- **SLA Escalation (Enforced by @Zoe):** P0 â†’ immediate to @Ada + @Zoe | P1 â†’ â‰¤30 min to @Margaret + team lead | P2 â†’ â‰¤4 hours to team lead + @Rehab.
...
- Explicit phrase: `@Wave[N] â€” AUTOPILOT: execute all tasks`
...
## ðŸš€ GOVERNANCE UPGRADE V2 â€” LARGE WAVE EXECUTION MODE
...
3. **Collaboration Contract Upgrade (FEEDS_ACK required):**
   - Existing required tags stay mandatory:
     - `CONSUMESâ†@Agent: file#section`
     - `FEEDSâ†’@Agent: file#section`
   - New mandatory acceptance tag:
     - `FEEDS_ACKâ†@DownstreamAgent: accepted|revise + file#section`
...
5. **Large-Wave Premium Coding Standard:**
   - Premium coding executes in **3â€“6 module macro/huge-wave bundles** when dependencies are clear.
...
## âš¡ SUBAGENT EXECUTION UPGRADE â€” WORK BETTER MODE (Effective 2026-05-17)

## ðŸš€ PHASE 27 ADDENDUM â€” NEXT-LEVEL SUBAGENT OPERATIONS (Effective 2026-05-18)
...
- `Handoff` (`FEEDSâ†’...` + expected `FEEDS_ACK`)
...
| --------------------------------- | ----------------------------------------- | ------------------------------------- | ----------------------------------------------- |
| Squad A â€” Planning/Coordination | @Ada, @Margaret, @Grace, @Elena, @Zoe     | Architect, Planner, Explore, guardian | define scope, dependencies, truth maintenance   |
| Squad B â€” Frontend Delivery     | @Una, @Cyra, @Lea, @Tracy, @Africa        | Designer, SEO, Coder, QA              | homepage and public UX delivery                 |
| Squad C â€” Backend/Data Delivery | @Mira, @Petra, @Barbara, @Ruchi, @Daniela | Coder, Database, Security             | APIs, data, auth, business logic                |
| Squad D â€” QA/Security           | @Katherine, @Vera, @Radia, @Ecem, @Joy    | QA, Security, guardian                | verification, risk review, release gates        |
| Squad E â€” Release/Ops           | @Gwynne, @Pola, @Lila, @Rachel, @Lisa     | DevOps, SEO, guardian                 | CI, deploy, runtime, discoverability            |
| Squad F â€” Research Intelligence | @Elena, @Iris, @Aishaâ€“@Dana (#74â€“91)  | Explore, research                     | market research, preflight briefs, intelligence |
