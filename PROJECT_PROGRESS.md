...
*This document is maintained by @Margaret (Planner) and updated after every completed milestone.*  
*Architectural decisions are owned by @Ada and logged in the Daily Log section.*
