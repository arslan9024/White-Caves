...
const {
  // State getters
  activeSidebarItem, searchQuery, favorites, isCollapsed, viewMode,
  filters, currentPage, isMobileOpen, sortBy, itemsPerPage,
  
  // State setters
  setActive, setSearch, clearSearch,
  toggleExpanded, isExpanded,
  toggleFav, addFav, removeFav, isFavorited,
  toggleCollapse, setCollapsed, setMobileOpen,
  setView, setSort, setPage, setPageSize,
  addFilter, removeFilterKey, clearAllFilters,
  reset,
