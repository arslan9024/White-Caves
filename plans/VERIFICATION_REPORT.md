...
1. **Zoe** - MD Executive Assistant (Executive) - *Active*
2. **Clara** - Leads CRM Manager (Sales) - *Active*
3. **Mary** - Inventory CRM Manager (Operations) - *Active*
4. **Sophia** - Sales Pipeline Manager (Sales) - *Active*
5. **Theodora** - Finance Director (Finance) - *Active*
6. **Aurora** - CTO & Systems Architect (Technology) - *Active*
7. **Hazel** - Elite Frontend Engineer (Technology) - *Active*
8. **Willow** - Elite Backend Engineer (Technology) - *Active*
9. **Linda** - WhatsApp CRM Manager (Communications) - *Active*
10. **Nina** - WhatsApp Bot Developer (Communications) - *Active*
