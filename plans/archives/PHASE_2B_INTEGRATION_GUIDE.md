        ...
        <ul>
          {pendingSignatures.map(sig => (
            <li key={sig._id}>
              ...
              <a href={`/contracts/sign/${sig.contractId._id}/${sig.token}`}>Sign Now →</a>
            </li>
          ))}
        </ul>
      )}
  ...
  <div>
    ...
    {signatureStatus && (
      <div className="signature-status">
        ...
        <p>
          Signed: {signatureStatus.signed}/{signatureStatus.totalRequired}
        </p>
        ...
        {!signatureStatus.complete && (
          <button onClick={() => resendRequest()}>Resend Signature Request</button>
        )}
      </div>
    )}
  </div>
...
<html>
  <head>
    <style>
      ...
      .header {
        background: linear-gradient(135deg, #b03737, #b8860b);
        color: white;
        padding: 20px;
        border-radius: 8px;
      }
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          If you cannot click the link, copy and paste this URL in your browser:<br />
