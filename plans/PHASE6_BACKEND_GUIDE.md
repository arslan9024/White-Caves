...
// Register a worker
queue.registerWorker('send_notification', async (data) => {
...
await notifications.sendConversationInviteNotification(
  'user123',
  'Jane Smith',
  'conv789'
);
...
// Location
presence.setUserLocation('user123', 40.7128, -74.0060);
...
queueService.registerWorker('send_message', async (data) => {
...
queueService.registerWorker('process_analytics', async (data) => {
