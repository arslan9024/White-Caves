...
- **Phase 0/1 status:** baseline, canonical policy tagging, planning-truth reconciliation, docs/plans dedup matrix, business-doc canonical-root decision, frontend overlap audit, backend overlap audit, and safe-delete wave completed (W46-001..W46-008); W46-009 CI anti-dup checks are now active.
