...
| --- | --- | --- | --- | --- | --- |
| W14-001 | P0 | Implement lead auto-rescore triggers for lifecycle events | @Mira + @LeadScore | targeted scoring tests | Planned |
| W14-002 | P0 | Build audit log UI with filters/pagination | @Una + @Mira | `npm run build` | Planned |
