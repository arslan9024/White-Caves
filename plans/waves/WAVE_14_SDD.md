# Wave 14 — System Design Document (SDD)

**Wave:** 14  
**Focus:** Product Features (Lead Scoring + Audit Log UI + Mortgage + Calendar + Multi-Currency)  
**Status:** 📋 Planned  
**Date:** 2026-05-24  
...
- Item 34: lead scoring auto-trigger
- Item 37: audit log UI
- Item 35: mortgage API-backed calculator
- Item 36: calendar integration
- Item 38: multi-currency live rates
