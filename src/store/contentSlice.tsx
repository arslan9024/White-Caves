...
const contentSlice = createSlice({
  ...
  reducers: {
    ...
    setRentalProperties: (state, action: PayloadAction<Property[]>) => {
      state.rentalProperties = action.payload;
    },
    setHeroSlides: (state, action: PayloadAction<HeroSlide[]>) => {
    ...
    updateSliderSettings: (state, action: PayloadAction<Partial<SliderSettings>>) => {
    ...
    updateProperty: (state, action: PayloadAction<{ id: string | number; updates: Partial<Property> }>) => {
    ...
    removeProperty: (state, action: PayloadAction<string | number>) => {
...
export const selectFeaturedProperties = (state: any) => state.content?.featuredProperties || [];
export const selectRentalProperties = (state: any) => state.content?.rentalProperties || [];
export const selectHeroSlides = (state: any) => state.content?.heroSlides || [];
export const selectNeighborhoods = (state: any) => state.content?.neighborhoods || [];
export const selectServices = (state: any) => state.content?.services || [];
export const selectTestimonials = (state: any) => state.content?.testimonials || [];
export const selectSliderSettings = (state: any) => state.content?.sliderSettings || {};
export const selectContentLoading = (state: any) => state.content?.isLoading || false;
