...
export const fetchLeadsFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchLeads', async (params = {}, { rejectWithValue }) => {
  try {
...
export const fetchPropertiesFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchProperties', async (params = {}, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.page) query.set('page', String(params.page));
    if (params.pageSize) query.set('pageSize', String(params.pageSize));
...
export const fetchAgentsFromAPI = createAsyncThunk<CRMItem[], void, { rejectValue: string }>(
  'crmData/fetchAgents',
...
export const fetchDashboardOverview = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchDashboardOverview', async (_, { rejectWithValue }) => {
  try {
...
export const createLeadAPI = createAsyncThunk<
  ...
  Record<string, unknown>,
  { rejectValue: string }
>('crmData/createLead', async (leadData, { rejectWithValue }) => {
  try {
...
export const updateLeadAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateLeadAPI', async ({ id, ...updates }, { rejectWithValue }) => {
  try {
...
export const deleteLeadAPI = createAsyncThunk<
  ...
  string | number,
  { rejectValue: string }
>('crmData/deleteLeadAPI', async (id, { rejectWithValue }) => {
  try {
...
export const createPropertyAPI = createAsyncThunk<
  ...
  Record<string, unknown>,
  { rejectValue: string }
>('crmData/createProperty', async (propertyData, { rejectWithValue }) => {
  try {
...
export const updatePropertyAPI = createAsyncThunk<
  ...
  { id: string | number } & Record<string, unknown>,
  { rejectValue: string }
>('crmData/updateProperty', async ({ id, ...updates }, { rejectWithValue }) => {
  try {
...
export const deletePropertyAPI = createAsyncThunk<
  ...
  string | number,
  { rejectValue: string }
>('crmData/deleteProperty', async (id, { rejectWithValue }) => {
  try {
...
export const fetchCommissionsFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchCommissions', async (params = {}, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.page) query.set('page', String(params.page));
    if (params.pageSize) query.set('pageSize', String(params.pageSize));
...
export const fetchFinanceSummary = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchFinanceSummary', async (_, { rejectWithValue }) => {
  try {
...
export const updateCommissionAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateCommissionAPI', async ({ id, ...updates }, { rejectWithValue }) => {
  try {
...
export const bulkPayCommissionsAPI = createAsyncThunk<
  ...
  string[],
  { rejectValue: string }
>('crmData/bulkPayCommissions', async (commissionIds, { rejectWithValue }) => {
  try {
...
export const fetchInvoicesFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchInvoices', async (params = {}, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.page) query.set('page', String(params.page));
    if (params.pageSize) query.set('pageSize', String(params.pageSize));
...
export const createInvoiceAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/createInvoice', async (invoiceData, { rejectWithValue }) => {
  try {
...
export const updateInvoiceAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateInvoice', async ({ id, ...updates }, { rejectWithValue }) => {
  try {
...
export const deleteInvoiceAPI = createAsyncThunk<string, string, { rejectValue: string }>(
  'crmData/deleteInvoice',
  async (id, { rejectWithValue }) => {
    try {
      const response = await authFetch(`/api/finance/invoices/${id}`, { method: 'DELETE' });
      if (!response.ok)
        throw new Error(await extractApiError(response, 'Failed to delete invoice'));
      return id;
    } catch (error: unknown) {
...
export const fetchExpensesFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchExpenses', async (params = {}, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.page) query.set('page', String(params.page));
    if (params.pageSize) query.set('pageSize', String(params.pageSize));
...
export const createExpenseAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/createExpense', async (expenseData, { rejectWithValue }) => {
  try {
...
export const updateExpenseAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateExpense', async ({ id, ...updates }, { rejectWithValue }) => {
  try {
...
export const deleteExpenseAPI = createAsyncThunk<string, string, { rejectValue: string }>(
  'crmData/deleteExpense',
  async (id, { rejectWithValue }) => {
    try {
      const response = await authFetch(`/api/finance/expenses/${id}`, { method: 'DELETE' });
      if (!response.ok)
        throw new Error(await extractApiError(response, 'Failed to delete expense'));
      return id;
    } catch (error: unknown) {
...
export const fetchClientsFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchClients', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.status) query.set('status', params.status);
    if (params.category) query.set('category', params.category);
...
export const createClientAPI = createAsyncThunk<
  ...
  Record<string, unknown>,
  { rejectValue: string }
>('crmData/createClient', async (data, { rejectWithValue }) => {
  try {
...
export const updateClientAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateClient', async ({ id, ...updates }, { rejectWithValue }) => {
  try {
...
export const deleteClientAPI = createAsyncThunk<string, string, { rejectValue: string }>(
...
export const linkClientPropertyAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/linkClientProperty', async ({ clientId, ...data }, { rejectWithValue }) => {
  try {
...
export const unlinkClientPropertyAPI = createAsyncThunk<
  ...
  { clientId: string; propertyId: string },
  { rejectValue: string }
>('crmData/unlinkClientProperty', async ({ clientId, propertyId }, { rejectWithValue }) => {
  try {
...
export const fetchClientCommunicationsAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchClientCommunications', async ({ clientId, ...params }, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.type) query.set('type', params.type);
    if (params.page) query.set('page', String(params.page));
    ...
    const response = await authFetch(url);
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch communications'));
    const json = await response.json();
    return json.data || [];
  } catch (error: unknown) {
...
export const createClientCommunicationAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/createClientCommunication', async ({ clientId, ...data }, { rejectWithValue }) => {
  try {
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to log communication'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const convertLeadToClientAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/convertLeadToClient', async ({ leadId, ...data }, { rejectWithValue }) => {
  try {
...
export const scoreLeadAPI = createAsyncThunk<CRMItem, string, { rejectValue: string }>(
  'crmData/scoreLead',
...
export const overrideLeadScoreAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/overrideLeadScore', async ({ leadId, score, reason }, { rejectWithValue }) => {
  try {
...
export const batchRescoreLeadsAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/batchRescoreLeads', async (_, { rejectWithValue }) => {
  try {
...
export const fetchScoredLeadsAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchScoredLeads', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch scored leads'));
    const json = await response.json();
    return json;
  } catch (error: unknown) {
...
export const fetchRoutingRulesAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchRoutingRules', async (_, { rejectWithValue }) => {
  try {
    const response = await authFetch('/api/leads/routing-rules');
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch routing rules'));
    const json = await response.json();
    return json;
  } catch (error: unknown) {
...
export const fetchScoreHistoryAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchScoreHistory', async ({ leadId, limit, days }, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch score history'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const fetchLeadTrendingAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchLeadTrending', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params && typeof params === 'object') {
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch lead trending'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const applyWhatsAppScoreAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/applyWhatsAppScore', async ({ leadId, signals }, { rejectWithValue }) => {
  try {
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to apply WhatsApp score'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const autoRouteLeadAPI = createAsyncThunk<
  ...
  string,
  { rejectValue: string }
>('crmData/autoRouteLead', async (leadId, { rejectWithValue }) => {
  try {
...
export const fetchLeadRoutingAgentsAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchLeadRoutingAgents', async (_, { rejectWithValue }) => {
  try {
    const response = await authFetch('/api/leads/agent-performance');
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch agent performance'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const startFollowUpAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/startFollowUp', async ({ leadId, cadenceType }, { rejectWithValue }) => {
  try {
...
export const fetchLeadFollowUpsAPI = createAsyncThunk<
  ...
  string,
  { rejectValue: string }
>('crmData/fetchLeadFollowUps', async (leadId, { rejectWithValue }) => {
  try {
...
export const pauseFollowUpAPI = createAsyncThunk<void, string, { rejectValue: string }>(
  'crmData/pauseFollowUp',
  async (sequenceId, { rejectWithValue }) => {
    try {
      const res = await authFetch(`/api/follow-ups/sequence/${sequenceId}/pause`, {
        method: 'POST',
      });
      const json = await res.json();
...
export const resumeFollowUpAPI = createAsyncThunk<void, string, { rejectValue: string }>(
  'crmData/resumeFollowUp',
  async (sequenceId, { rejectWithValue }) => {
    try {
      const res = await authFetch(`/api/follow-ups/sequence/${sequenceId}/resume`, {
        method: 'POST',
      });
      const json = await res.json();
...
export const cancelFollowUpAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/cancelFollowUp', async ({ sequenceId, reason }, { rejectWithValue }) => {
  try {
...
export const fetchFollowUpStatsAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchFollowUpStats', async (_, { rejectWithValue }) => {
  try {
...
export const generateDocumentAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/generateDocument', async (input, { rejectWithValue }) => {
  try {
...
export const fetchDocumentsAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchDocuments', async (filters, { rejectWithValue }) => {
  try {
...
export const fetchDocumentTypesAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchDocumentTypes', async (_, { rejectWithValue }) => {
  try {
...
// ============================================================================
// DOCUMENT AUTO-FILL THUNKS (Phase 4B)
// ============================================================================

/** Auto-generate a document from DB records — POST /api/documents/generate-auto */
export const autoGenerateDocumentAPI = createAsyncThunk<
  { document: Record<string, unknown>; autoFillContext: Record<string, unknown> },
  {
    type: string;
    leadId?: string;
    propertyId?: string;
  ...
  { rejectValue: string }
>('crmData/autoGenerateDocument', async (input, { rejectWithValue }) => {
  try {
    const res = await authFetch('/api/documents/generate-auto', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(input),
    });
    const json = await res.json();
    if (!res.ok) return rejectWithValue(json.error || 'Failed to auto-generate document');
    return json.data;
  } catch (error: unknown) {
    return rejectWithValue(getErrorMessage(error, 'Failed to auto-generate document'));
  }
});

/** Preview auto-filled variables — POST /api/documents/auto-fill/preview */
export const previewAutoFillAPI = createAsyncThunk<
  { variables: Record<string, string>; context: Record<string, unknown> },
  {
    type: string;
    leadId?: string;
    propertyId?: string;
  ...
  { rejectValue: string }
>('crmData/previewAutoFill', async (input, { rejectWithValue }) => {
  try {
    const res = await authFetch('/api/documents/auto-fill/preview', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(input),
    });
    const json = await res.json();
    if (!res.ok) return rejectWithValue(json.error || 'Failed to preview auto-fill');
    return json.data;
  } catch (error: unknown) {
    return rejectWithValue(getErrorMessage(error, 'Failed to preview auto-fill'));
  }
});

/** Get auto-fill entity requirements — GET /api/documents/auto-fill/entities */
export const fetchAutoFillEntitiesAPI = createAsyncThunk<
  Array<{ type: string; label: string; requiredEntities: string[]; optionalEntities: string[] }>,
  void,
  { rejectValue: string }
>('crmData/fetchAutoFillEntities', async (_, { rejectWithValue }) => {
  try {
    const res = await authFetch('/api/documents/auto-fill/entities');
    const json = await res.json();
    if (!res.ok) return rejectWithValue(json.error || 'Failed to fetch auto-fill entities');
    return json.data;
  } catch (error: unknown) {
    return rejectWithValue(getErrorMessage(error, 'Failed to fetch auto-fill entities'));
  }
});
...
export const fetchMarketOverviewAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchMarketOverview', async (_, { rejectWithValue }) => {
  try {
...
export const fetchPriceTrendsAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchPriceTrends', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params) {
      if (params.area) query.set('area', params.area);
...
export const fetchRentalYieldsAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchRentalYields', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params) {
      if (params.area) query.set('area', params.area);
...
export const fetchComparablesAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchComparables', async ({ propertyId, limit }, { rejectWithValue }) => {
  try {
...
export const fetchDemandHeatmapAPI = createAsyncThunk<
  ...
  { days?: number } | void,
  { rejectValue: string }
>('crmData/fetchDemandHeatmap', async (params, { rejectWithValue }) => {
  try {
...
export const fetchOfferSpreadAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchOfferSpread', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params) {
      if (params.area) query.set('area', params.area);
...
export const classifyWhatsAppIntentAPI = createAsyncThunk<
  ...
  { message: string },
  { rejectValue: string }
>('crmData/classifyWhatsAppIntent', async (payload, { rejectWithValue }) => {
  try {
...
export const generateWhatsAppAutoResponseAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/generateWhatsAppAutoResponse', async (payload, { rejectWithValue }) => {
  try {
...
export const sendWhatsAppAutoResponseAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/sendWhatsAppAutoResponse', async (payload, { rejectWithValue }) => {
  try {
...
export const fetchLeadFunnelAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchLeadFunnel', async (_, { rejectWithValue }) => {
  try {
...
export const fetchTrendsAPI = createAsyncThunk<
  ...
  { days?: number } | void,
  { rejectValue: string }
>('crmData/fetchTrends', async (params, { rejectWithValue }) => {
  try {
...
export const fetchPropertyAgingAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchPropertyAging', async (_, { rejectWithValue }) => {
  try {
...
export const fetchAgentPerformanceAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchAgentPerformance', async (_, { rejectWithValue }) => {
  try {
...
export const fetchExecutiveDashboardAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchExecutiveDashboard', async (_, { rejectWithValue }) => {
  try {
...
export const fetchKPIsAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchKPIs', async (_, { rejectWithValue }) => {
  try {
...
export const fetchExchangeRatesAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchExchangeRates', async (_, { rejectWithValue }) => {
  try {
...
export const fetchSupportedCurrenciesAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchSupportedCurrencies', async (_, { rejectWithValue }) => {
  try {
...
export const convertCurrencyAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/convertCurrency', async ({ amount, from, to }, { rejectWithValue }) => {
  try {
...
export const sendEmailAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/sendEmail', async (payload, { rejectWithValue }) => {
  try {
...
export const sendTemplateEmailAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/sendTemplateEmail', async (payload, { rejectWithValue }) => {
  try {
...
export const fetchEmailTemplatesAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchEmailTemplates', async (_, { rejectWithValue }) => {
  try {
...
export const fetchEmailStatsAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchEmailStats', async (_, { rejectWithValue }) => {
  try {
...
export const fetchAvailableSlotsAPI = createAsyncThunk<
  {
    ...
    slots: Array<{ start: string; end: string; available: boolean; reason?: string }>;
  },
  { agentId: string; date: string; duration?: number },
  { rejectValue: string }
>('crmData/fetchAvailableSlots', async (params, { rejectWithValue }) => {
  try {
...
export const fetchAgentAvailabilityAPI = createAsyncThunk<
  ...
  string,
  { rejectValue: string }
>('crmData/fetchAgentAvailability', async (agentId, { rejectWithValue }) => {
  try {
...
export const setAgentAvailabilityAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/setAgentAvailability', async (data, { rejectWithValue }) => {
  try {
...
export const downloadViewingICSAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/downloadViewingICS', async ({ viewingId, token }, { rejectWithValue }) => {
  try {
...
export const fetchBRNExpiryAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchBRNExpiry', async (_, { rejectWithValue }) => {
  try {
...
export const fetchVATSummaryAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchVATSummary', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
...
export const fetchComplianceOverviewAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchComplianceOverview', async (_, { rejectWithValue }) => {
  try {
...
export const downloadEjariExportAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/downloadEjariExport', async (params, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
...
export const updateEjariStatusAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateEjariStatus', async ({ leaseId, ...data }, { rejectWithValue }) => {
  try {
...
export const fetchActivitiesFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchActivities', async (params = {}, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.type) query.set('type', params.type);
    ...
    const response = await authFetch(url);
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch activities'));
    const json = await response.json();
...
export const createActivityAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/createActivity', async (data, { rejectWithValue }) => {
  try {
...
export const updateActivityAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateActivity', async ({ id, ...data }, { rejectWithValue }) => {
  try {
...
export const deleteActivityAPI = createAsyncThunk<string, string, { rejectValue: string }>(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      if (!response.ok)
        throw new Error(await extractApiError(response, 'Failed to delete activity'));
      return id;
    } catch (error: unknown) {
...
export const fetchTransactionsFromAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/fetchTransactions', async (params = {}, { rejectWithValue }) => {
  try {
    const query = new URLSearchParams();
    if (params.status) query.set('status', params.status);
    if (params.type) query.set('type', params.type);
    ...
    const response = await authFetch(url);
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch transactions'));
    const json = await response.json();
    return { data: json.data, pagination: json.pagination };
  } catch (error: unknown) {
...
export const createTransactionAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/createTransaction', async (data, { rejectWithValue }) => {
  try {
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to create transaction'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const updateTransactionAPI = createAsyncThunk<
  ...
  { rejectValue: string }
>('crmData/updateTransaction', async ({ id, ...data }, { rejectWithValue }) => {
  try {
    ...
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to update transaction'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
export const deleteTransactionAPI = createAsyncThunk<string, string, { rejectValue: string }>(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      if (!response.ok)
        throw new Error(await extractApiError(response, 'Failed to delete transaction'));
      return id;
    } catch (error: unknown) {
...
export const fetchTransactionStatsAPI = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('crmData/fetchTransactionStats', async (_, { rejectWithValue }) => {
  try {
    const response = await authFetch('/api/transactions/stats');
    if (!response.ok)
      throw new Error(await extractApiError(response, 'Failed to fetch transaction stats'));
    const json = await response.json();
    return json.data;
  } catch (error: unknown) {
...
const crmDataSlice = createSlice({
  ...
  reducers: {
    ...
    updateLead: (state, action: PayloadAction<CRMItem>) => {
      const leadIndex = state.leads.items.findIndex(l => l.id === action.payload.id);
      if (leadIndex > -1) {
    ...
    updateClient: (state, action: PayloadAction<CRMItem>) => {
      const clientIndex = state.clients.items.findIndex(c => c.id === action.payload.id);
      if (clientIndex > -1) {
    ...
    updateAgent: (state, action: PayloadAction<CRMItem>) => {
      const agentIndex = state.agents.items.findIndex(a => a.id === action.payload.id);
      if (agentIndex > -1) {
    ...
    updateProperty: (state, action: PayloadAction<CRMItem>) => {
      const propIndex = state.properties.items.findIndex(p => p.id === action.payload.id);
      if (propIndex > -1) {
    ...
    updateCommission: (state, action: PayloadAction<CRMItem>) => {
      const commIndex = state.commissions.items.findIndex(c => c.id === action.payload.id);
      if (commIndex > -1) {
  ...
  extraReducers: builder => {
    ...
    builder
      ...
      .addCase(fetchLeadsFromAPI.rejected, (state, action) => {
        state.leads.loading = false;
        state.leads.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to fetch leads';
      });
    ...
    builder
      ...
      .addCase(fetchAgentsFromAPI.rejected, (state, action) => {
        state.agents.loading = false;
        state.agents.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to fetch agents';
      });
    ...
    builder
      ...
      .addCase(createLeadAPI.rejected, (state, action) => {
        state.leads.loading = false;
        state.leads.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to create lead';
      });
    ...
    builder
      ...
      .addCase(updateLeadAPI.rejected, (state, action) => {
        state.leads.loading = false;
        state.leads.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to update lead';
      });
    ...
    builder
      ...
      .addCase(deleteLeadAPI.rejected, (state, action) => {
        state.leads.loading = false;
        state.leads.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to delete lead';
      });
    ...
    builder
      ...
      .addCase(fetchClientsFromAPI.rejected, (state, action) => {
        state.clients.loading = false;
        state.clients.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to fetch clients';
      });
    ...
    builder
      ...
      .addCase(createClientAPI.rejected, (state, action) => {
        state.clients.loading = false;
        state.clients.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to create client';
      });
    ...
    builder
      ...
      .addCase(updateClientAPI.rejected, (state, action) => {
        state.clients.loading = false;
        state.clients.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to update client';
      });
    ...
    builder
      ...
      .addCase(deleteClientAPI.rejected, (state, action) => {
        state.clients.loading = false;
        state.clients.error =
          (typeof action.payload === 'string' ? action.payload : null) || 'Failed to delete client';
      });

    // --- Convert Lead to Client ---
    builder.addCase(convertLeadToClientAPI.fulfilled, (state, action) => {
      if (action.payload) {
        state.clients.items.unshift(action.payload);
      }
      state.lastUpdated = new Date().toISOString();
...
// ── Leads ──
export const selectAllLeads = createSelector(selectLeadsSlice, leads => leads?.items || []);
export const selectHotLeads = createSelector(selectAllLeads, items =>
  items.filter((l: CRMItem) => l.status === 'hot')
);
export const selectWarmLeads = createSelector(selectAllLeads, items =>
  items.filter((l: CRMItem) => l.status === 'warm')
);
export const selectColdLeads = createSelector(selectAllLeads, items =>
  items.filter((l: CRMItem) => l.status === 'cold')
);
...
export const selectHotTierLeads = createSelector(selectAllLeads, items =>
  items.filter(
    (l: CRMItem) => l.scoreTier === 'hot' || (typeof l.score === 'number' && l.score >= 80)
  )
);
export const selectWarmTierLeads = createSelector(selectAllLeads, items =>
  items.filter(
    (l: CRMItem) =>
      l.scoreTier === 'warm' || (typeof l.score === 'number' && l.score >= 60 && l.score < 80)
  )
);
export const selectColdTierLeads = createSelector(selectAllLeads, items =>
  items.filter(
    (l: CRMItem) =>
      l.scoreTier === 'cold' || (typeof l.score === 'number' && l.score >= 30 && l.score < 60)
  )
);
export const selectInactiveTierLeads = createSelector(selectAllLeads, items =>
  items.filter(
    (l: CRMItem) => l.scoreTier === 'inactive' || (typeof l.score === 'number' && l.score < 30)
  )
);
export const selectLeadsByMinScore = (state: RootState, minScore: number) =>
  state.crmData?.leads?.items?.filter(
    (l: CRMItem) => typeof l.score === 'number' && l.score >= minScore
  ) || [];

// ── Clients ──
export const selectAllClients = createSelector(selectClientsSlice, clients => clients?.items || []);
...
export const selectBuyerClients = createSelector(selectAllClients, items =>
  items.filter((c: CRMItem) => c.category === 'buyer')
);
export const selectSellerClients = createSelector(selectAllClients, items =>
  items.filter((c: CRMItem) => c.category === 'seller')
);
export const selectLandlordClients = createSelector(selectAllClients, items =>
  items.filter((c: CRMItem) => c.category === 'landlord')
);
export const selectTenantClients = createSelector(selectAllClients, items =>
  items.filter((c: CRMItem) => c.category === 'tenant')
);
export const selectInvestorClients = createSelector(selectAllClients, items =>
  items.filter((c: CRMItem) => c.category === 'investor')
);
export const selectActiveClients = createSelector(selectAllClients, items =>
  items.filter((c: CRMItem) => c.status === 'active')
);
...
// ── Agents ──
export const selectAllAgents = createSelector(selectAgentsSlice, agents => agents?.items || []);
...
export const selectOnlineAgents = createSelector(selectAllAgents, items =>
  items.filter((a: CRMItem) => a.status === 'online')
);
...
export const selectAvailableProperties = createSelector(selectAllProperties, items =>
  items.filter((p: CRMItem) => p.status === 'available')
);
...
export const selectPendingCommissions = createSelector(selectAllCommissions, items =>
  items.filter((c: CRMItem) => c.status === 'pending')
);
export const selectApprovedCommissions = createSelector(selectAllCommissions, items =>
  items.filter((c: CRMItem) => c.status === 'approved')
);
export const selectPaidCommissions = createSelector(selectAllCommissions, items =>
  items.filter((c: CRMItem) => c.status === 'paid')
);
...
export const selectCommissionsByAgent = (state: RootState, agentId: string | number) =>
  state.crmData?.commissions?.items?.filter(
    (c: CRMItem) => c.agentId === agentId || c.agent_id === agentId
  ) || [];
...
export const selectPendingInvoices = createSelector(selectAllInvoices, items =>
  items.filter((i: CRMItem) => i.status === 'pending')
);
export const selectPaidInvoices = createSelector(selectAllInvoices, items =>
  items.filter((i: CRMItem) => i.status === 'paid')
);
export const selectOverdueInvoices = createSelector(selectAllInvoices, items =>
  items.filter((i: CRMItem) => i.status === 'overdue')
);
export const selectDraftInvoices = createSelector(selectAllInvoices, items =>
  items.filter((i: CRMItem) => i.status === 'draft')
);
...
export const selectPendingExpenses = createSelector(selectAllExpenses, items =>
  items.filter((e: CRMItem) => e.status === 'pending')
);
export const selectApprovedExpenses = createSelector(selectAllExpenses, items =>
  items.filter((e: CRMItem) => e.status === 'approved')
);
export const selectRejectedExpenses = createSelector(selectAllExpenses, items =>
  items.filter((e: CRMItem) => e.status === 'rejected')
);
...
export const selectDraftTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.status === 'draft')
);
export const selectPendingTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.status === 'pending')
);
export const selectActiveTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.status === 'active')
);
export const selectCompletedTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.status === 'completed')
);
export const selectCancelledTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.status === 'cancelled')
);
export const selectSaleTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.type === 'sale')
);
export const selectLeaseTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.type === 'lease')
);
export const selectRentalTransactions = createSelector(selectAllTransactions, items =>
  items.filter((t: CRMItem) => t.type === 'rental')
);
...
export const selectLeadActivities = createSelector(selectAllActivities, items =>
  items.filter((a: CRMItem) => a.type === 'lead')
);
export const selectDealActivities = createSelector(selectAllActivities, items =>
  items.filter((a: CRMItem) => a.type === 'deal')
);
export const selectPropertyActivities = createSelector(selectAllActivities, items =>
  items.filter((a: CRMItem) => a.type === 'property')
);
export const selectSystemActivities = createSelector(selectAllActivities, items =>
  items.filter((a: CRMItem) => a.type === 'system')
);
...
export const selectAllNotifications = selectAllActivities;
export const selectUnreadCount = createSelector(
  selectAllActivities,
  activities => activities.filter((a: CRMItem) => !a.read).length
);
export const selectNotificationsLoading = selectActivitiesLoading;
export const selectNotificationsError = selectActivitiesError;
