...
const AI_ASSISTANTS_REGISTRY = [
  ...
  },
  {
    ...
    status: 'online',
    isTeamLead: true,
    teamName: 'SDLC Documentation Team',
  },
  {
    id: 'theodora',
    name: 'Theodora',
  ...
  },
  {
    ...
    status: 'online',
    reportsTo: 'aurora',
    specialty: 'API & Server Architecture',
  },
  {
    id: 'nova',
    name: 'Nova',
    ...
    status: 'online',
    reportsTo: 'aurora',
    specialty: 'Data Processing & Integration',
  },
  {
    id: 'ember',
    name: 'Ember',
    ...
    status: 'online',
    reportsTo: 'aurora',
    specialty: 'UI Documentation & Standards',
  },
  {
    id: 'marina',
    name: 'Marina',
    ...
    status: 'online',
    reportsTo: 'aurora',
    specialty: 'Deployment & Operations',
  },
  {
    id: 'coral',
    name: 'Coral',
    ...
    status: 'online',
    reportsTo: 'aurora',
    specialty: 'Schema & Data Management',
  },
  {
    id: 'celeste',
    name: 'Celeste',
    ...
    status: 'online',
    reportsTo: 'aurora',
    specialty: 'ML Pipeline Documentation',
  },
];
...
const initialState = {
  ...
  breadcrumbs: [
    ...
    { id: 'md-dashboard', label: 'MD Dashboard' },
  ],
  recentObjects: [],
  favoriteObjects: [],
...
export const selectActiveObjectId = createSelector([selectCrmView], cv => cv?.activeObjectId);

export const selectActiveAssistant = createSelector([selectCrmView], cv => cv?.activeAssistant);

export const selectSidebarOpen = createSelector([selectCrmView], cv => cv?.sidebarOpen ?? true);

export const selectAiPanelOpen = createSelector([selectCrmView], cv => cv?.aiPanelOpen ?? false);
...
export const selectViewMode = createSelector([selectCrmView], cv => cv?.viewMode || 'grid');

export const selectSearchQuery = createSelector([selectCrmView], cv => cv?.searchQuery || '');

export const selectFilterState = createSelector([selectCrmView], cv => cv?.filterState || {});

export const selectBreadcrumbs = createSelector([selectCrmView], cv => cv?.breadcrumbs || []);

export const selectRecentObjects = createSelector([selectCrmView], cv => cv?.recentObjects || []);
...
export const selectNavTree = createSelector([selectCrmView], cv => cv?.navTree || CRM_NAV_TREE);

export const selectExpandedGroups = createSelector([selectCrmView], cv => cv?.expandedGroups || []);

export const selectActiveSubItem = createSelector([selectCrmView], cv => cv?.activeSubItem);
...
export const selectActiveDocument = createSelector([selectCrmView], cv => cv?.activeDocument);
