    ...
    laila: [
      {
        id: 'n8',
        type: 'compliance',
        message: 'KYC review required for new tenant file',
        severity: 'warning',
        isRead: false,
    ...
    aurora: [
      {
        id: 'n9',
        type: 'system',
        message: 'Minor latency spike detected on API gateway',
        severity: 'info',
        isRead: false,
...
export const generateTasks = (): Record<string, Task[]> => ({
  ...
  mary: [
    {
      id: 't4',
      title: 'Validate weekly inventory sync',
      priority: 'medium',
      status: 'pending',
      assignedTo: null,
      dueDate: new Date().toISOString(),
  ...
  sophia: [
    {
      id: 't5',
      title: 'Review top pipeline deals',
      priority: 'high',
      status: 'in_progress',
      assignedTo: 'sales_manager_1',
      dueDate: new Date().toISOString(),
    },
  ],
  daisy: [],
  ...
  aurora: [
    {
      id: 't6',
      title: 'Audit production error budget',
      priority: 'medium',
      status: 'pending',
      assignedTo: null,
      dueDate: new Date().toISOString(),
