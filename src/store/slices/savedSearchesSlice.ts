...
export const fetchSavedSearches = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>('savedSearches/fetchAll', async (_, { rejectWithValue }) => {
  try {
...
export const createSavedSearch = createAsyncThunk<
  ...
  { rejectValue: string }
>('savedSearches/create', async ({ name, filters, alertEnabled }, { rejectWithValue }) => {
  try {
...
export const updateSavedSearch = createAsyncThunk<
  ...
  { rejectValue: string }
>('savedSearches/update', async ({ id, updates }, { rejectWithValue }) => {
  try {
...
export const deleteSavedSearch = createAsyncThunk<string, string, { rejectValue: string }>(
...
export const checkSearchMatches = createAsyncThunk<
  ...
  string,
  { rejectValue: string }
>('savedSearches/checkMatches', async (id, { rejectWithValue }) => {
  try {
...
export const selectSavedSearchCount = createSelector(selectSavedSearches, items => items.length);
