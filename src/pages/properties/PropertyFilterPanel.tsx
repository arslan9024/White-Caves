...
import {
  Search, SlidersHorizontal, X, ChevronDown, MapPin, Home,
  BedDouble, Bath, DollarSign, ArrowUpDown, RotateCcw,
} from 'lucide-react';
...
const PropertyFilterPanel: React.FC<PropertyFilterPanelProps> = memo(
  function PropertyFilterPanel({ resultCount, totalCount }) {
            ...
            <div className="filter-advanced-grid">
              ...
              <div className="filter-advanced-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateFilter('minSqft', parseInt(e.target.value, 10) || 0)
                  }
                />
              </div>
              ...
              <div className="filter-advanced-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateFilter('maxSqft', parseInt(e.target.value, 10) || 20000)
                  }
                />
              </div>
          ...
          {activeFilterCount > 0 && (
            <div className="filter-active-pills">
              ...
              {(filters.minPrice > 0 || filters.maxPrice < 100_000_000) && (
                <span className="filter-pill">
                  {filters.minPrice > 0
                    ? `${(filters.minPrice / 1_000_000).toFixed(0)}M`
                    : '0'}{' '}
                  –{' '}
