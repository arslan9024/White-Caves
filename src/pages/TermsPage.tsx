...
const TermsPage: FC = () => {
  useSEO({
    title: 'Terms of Service | White Caves Real Estate',
    description: 'Review the terms and conditions for using White Caves Real Estate services.',
      ...
      <div className="legal-page">
        <div className="legal-container">
          ...
          <section className="legal-section">
            ...
            <p>
              By accessing and using this website operated by White Caves Real Estate LLC, you
              accept and agree to be bound by and comply with these terms and conditions. If you do
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              or software) on White Caves Real Estate&apos;s website for personal, non-commercial
            ...
            <ul>
              ...
              <li>
                Transfer the materials to another person or &ldquo;mirror&rdquo; the materials on
                any other server
              </li>
              <li>
          ...
          <section className="legal-section">
            <h2>3. Disclaimer</h2>
            <p>
              The materials on White Caves Real Estate&apos;s website are provided &ldquo;as
              is&rdquo;. White Caves Real Estate makes no warranties, expressed or implied, and
          ...
          <section className="legal-section">
            <h2>4. Limitations</h2>
            <p>
              In no event shall White Caves Real Estate or its suppliers be liable for any damages
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              photographic errors. White Caves Real Estate does not warrant that any of the
          ...
          <section className="legal-section">
            <h2>6. Links</h2>
            <p>
              White Caves Real Estate has not reviewed all of the sites linked to its website and is
              not responsible for the contents of any such linked site. The inclusion of any link
              does not imply endorsement by us of the site. Use of any such linked website is at the
              user&apos;s own risk.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              White Caves Real Estate may revise these terms and conditions for our website at any
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              of the United Arab Emirates, and you irrevocably submit to the exclusive jurisdiction
