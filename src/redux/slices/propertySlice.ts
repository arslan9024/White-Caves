...
export const propertySearchSlice = createSlice({
  ...
  initialState,
  reducers: {
    setIntentProfile(state, action: PayloadAction<'buy' | 'rent' | 'invest' | null>) {
...
export const selectIntentProfile = (s: StateWithPropertySearch) => s.propertySearch.intentProfile;
export const selectPropertySearchFilters = (s: StateWithPropertySearch) => s.propertySearch.filters;
export const selectViewportBounds = (s: StateWithPropertySearch) => s.propertySearch.viewportBounds;
