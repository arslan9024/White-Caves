...
const getStoredCredentials = (): any[] => {
  try {
...
const saveCredentialLocally = (credential: any, userId: string): void => {
...
const getBiometricCredentials = (): any[] => {
  return getStoredCredentials();
};

const saveBiometricSession = (userData: any, token: string): void => {
...
const getBiometricSession = (): any | null => {
  try {
