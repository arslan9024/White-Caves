...
export const WHITE_CAVES_ROLES: JobRole[] = [
  ...
  // ─── LEASING & TENANCY DEPARTMENT ────────────────────────────────────────────
  {
    roleId: 'LSG-001',
    departmentId: 'leasing',
    title: 'Head of Leasing & Tenancy (Department Manager)',
    tier: 'Executive',
    defaultAccessLevel: AccessLevel.LEVEL_4_DEPARTMENT_HEAD,
  },
  {
    roleId: 'LSG-002',
    departmentId: 'leasing',
    title: 'Senior Ejari Registration Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-003',
    departmentId: 'leasing',
    title: 'PDC Cheque Management Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-004',
    departmentId: 'leasing',
    title: 'Tenant Onboarding & KYC Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-005',
    departmentId: 'leasing',
    title: 'Lease Renewal & Termination Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-006',
    departmentId: 'leasing',
    title: 'Eviction & Legal Notice Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-007',
    departmentId: 'leasing',
    title: 'Rental Yield & Reporting Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-008',
    departmentId: 'leasing',
    title: 'Landlord Relations Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-009',
    departmentId: 'leasing',
    title: 'Commercial Leasing Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'LSG-010',
    departmentId: 'leasing',
    title: 'Off-Plan Handover Leasing Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
  ...
  // ─── MAINTENANCE & FACILITIES DEPARTMENT ─────────────────────────────────────
  {
    ...
    title: 'Head of Maintenance & Facilities (Department Manager)',
    tier: 'Executive',
    defaultAccessLevel: AccessLevel.LEVEL_4_DEPARTMENT_HEAD,
  },
  {
  ...
  },
  {
    roleId: 'MNT-003',
    departmentId: 'maintenance',
    title: 'Corrective Maintenance Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-004',
    departmentId: 'maintenance',
    title: 'Vendor & Contractor Management Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-005',
    departmentId: 'maintenance',
    title: 'IoT & Smart Building Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-006',
    departmentId: 'maintenance',
    title: 'HVAC & MEP Systems Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-007',
    departmentId: 'maintenance',
    title: 'Common Area & Landscaping Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-008',
    departmentId: 'maintenance',
    title: 'Tenant Handover & Inspection Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-009',
    departmentId: 'maintenance',
    title: 'Safety & Compliance (Facilities) Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
    roleId: 'MNT-010',
    departmentId: 'maintenance',
    title: 'Emergency Response & SLA Supervisor',
    tier: 'Senior',
    defaultAccessLevel: AccessLevel.LEVEL_3_POWER,
  },
  {
  ...
  },
  {
    roleId: 'MNT-012',
    departmentId: 'maintenance',
    title: 'Facilities Support Intern',
    tier: 'Intern',
    defaultAccessLevel: AccessLevel.LEVEL_1_READ,
  },
