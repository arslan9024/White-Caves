...
export const ASSISTANT_DOCS = {
  zoe: {
    overview:
      'Executive Assistant & Strategic Intelligence hub receiving AI-powered suggestions from all departments',
    phase: 'Production',
    version: '2.0',
    features: [
      {
        name: 'Executive Suggestion Inbox',
        status: 'active',
        description:
          'Receives prioritized suggestions from all 24 assistants with confidence scoring',
      },
      {
        name: 'Priority Filtering',
        status: 'active',
        description: 'Filter by priority (critical/high/medium/low) and department',
      },
      {
        name: 'Status Management',
        status: 'active',
        description: 'Acknowledge, escalate, or archive suggestions',
      },
      {
        name: 'Cross-Department Analytics',
        status: 'active',
        description: 'KPI dashboards pulling data from all departments',
      },
      {
      ...
      },
      {
        ...
        status: 'active',
        description: 'Priority-based task tracking for leadership',
      },
      {
        name: 'Confidential Vault Access',
        status: 'active',
        description: 'Dual-approval access to sensitive documents',
      },
    ],
    roadmap: [
  ...
  linda: {
    overview:
      'WhatsApp CRM Manager handling 23+ agent WhatsApp numbers with AI-powered lead qualification',
    phase: 'Production',
    version: '1.5',
    features: [
      {
        ...
        status: 'active',
        description: 'Manage 23+ WhatsApp Business accounts',
      },
      {
        name: 'Conversation Routing',
        status: 'active',
        description: 'Intelligent routing based on language, inquiry type, and agent availability',
      },
      {
        name: 'Template Messaging',
        status: 'active',
        description: 'Approved message templates for quick responses',
      },
      {
        name: 'Lead Pre-Qualification',
        status: 'active',
        description: 'AI-powered lead scoring from conversations',
      },
      {
        name: 'Quick Replies',
        status: 'active',
        description: 'Predefined responses for common inquiries',
      },
      {
        name: 'Broadcast Manager',
        status: 'active',
        description: 'Bulk messaging for campaigns and announcements',
      },
      {
    ...
    features: [
      {
        name: 'Bot Builder',
        status: 'active',
        description: 'Visual drag-and-drop bot creation interface',
      },
      {
        name: 'Flow Designer',
        status: 'active',
        description: 'Multi-step conversation flow management',
      },
      {
        name: 'Session Monitoring',
        status: 'active',
        description: 'Real-time bot session tracking',
      },
      {
        name: 'Bot Analytics',
        status: 'active',
        description: 'Performance metrics and engagement stats',
      },
      {
        name: 'Intent Classification',
        status: 'active',
        description: 'AI-powered message intent detection',
      },
      {
        name: 'Fallback Handling',
        status: 'active',
        description: 'Graceful escalation to human agents',
      },
    ],
    roadmap: [
  ...
  mary: {
    overview:
      'Inventory CRM Manager for DAMAC Hills 2 with 9,378+ property units and data acquisition tools',
    phase: 'Production',
    version: '2.1',
    features: [
      {
        ...
        status: 'active',
        description: 'Complete inventory of 9,378+ units across clusters',
      },
      {
        name: 'Cluster Browser',
        status: 'active',
        description: 'Navigate properties by cluster and unit type',
      },
      {
        name: 'DAMAC Asset Fetcher',
        status: 'active',
        description: 'Generate S3 URLs for property assets',
      },
      {
        name: 'Image Data Extractor',
        status: 'active',
        description: 'OCR-based data extraction from images',
      },
      {
        name: 'Web Data Harvester',
        status: 'active',
        description: 'Scrape property data from listing portals',
      },
      {
        name: 'Excel Import/Export',
        status: 'active',
        description: 'Bulk data management via spreadsheets',
      },
      {
        name: 'Filter & Search',
        status: 'active',
        description: 'Advanced filtering by status, price, size',
      },
    ],
    roadmap: [
    ...
    features: [
      {
        ...
        status: 'active',
        description: 'Complete staff database with profiles',
      },
      {
        name: 'Recruitment Pipeline',
        status: 'active',
        description: 'Candidate tracking from application to hire',
      },
      {
      ...
      },
      {
        ...
        status: 'active',
        description: 'Periodic evaluation management',
      },
      {
  ...
  daisy: {
    overview:
      'Leasing & Tenant Manager for rental properties, Ejari registration, and tenant lifecycle',
    phase: 'Production',
    version: '1.6',
    features: [
      {
      ...
      },
      {
        ...
        status: 'active',
        description: 'Complete tenant database with contracts',
      },
      {
        name: 'Ejari Integration',
        status: 'active',
        description: 'Digital Ejari registration workflow',
      },
      {
        name: 'Maintenance Requests',
        status: 'active',
        description: 'Tenant maintenance ticket system',
      },
      { name: 'Rent Collection', status: 'active', description: 'Payment tracking and reminders' },
      {
        name: 'Rental Analytics',
        status: 'active',
        description: 'Occupancy rates and yield analysis',
      },
      {
        name: 'Renewal Management',
        status: 'active',
        description: 'Automated lease renewal workflows',
      },
    ],
    roadmap: [
    ...
    features: [
      {
        name: 'Lead Pipeline',
        status: 'active',
        description: 'Visual pipeline with drag-and-drop stages',
      },
      {
        name: 'Lead Scoring',
        status: 'active',
      ...
      },
      {
        ...
        status: 'active',
        description: 'Complete interaction history per lead',
      },
      {
        name: 'Nurturing Workflows',
        status: 'active',
  ...
  sophia: {
    ...
    features: [
      { name: 'Deal Tracker', status: 'active', description: 'Track deals from offer to closing' },
      {
        name: 'Sales Pipeline',
        status: 'active',
        description: 'Visual deal progression management',
      },
      {
      ...
      },
      {
        ...
        status: 'active',
        description: 'Agent territory assignments',
      },
      {
  ...
  olivia: {
    ...
    features: [
      ...
      {
        name: 'Property Availability Sync',
        status: 'active',
        description: 'Auto-sync with Mary inventory',
      },
      {
      ...
      },
      {
        ...
        status: 'active',
        description: 'SEO and listing quality tools',
      },
      {
        name: 'Market Intelligence',
        status: 'active',
        description: 'Competitor tracking from Bayut/Dubizzle',
      },
      {
  ...
  aurora: {
    overview:
      'CTO & Systems Architect overseeing technical operations, deployments, and AI governance',
    phase: 'Production',
    version: '1.6',
    features: [
      {
      ...
      },
      {
        name: 'AI Governance',
        status: 'active',
        description: 'AI assistant performance and controls',
      },
      {
        name: 'Application Portfolio',
        status: 'active',
        description: 'Manage all company applications',
      },
  ...
  hazel: {
    ...
    features: [
      { name: 'Component Library', status: 'active', description: 'Reusable UI component catalog' },
      {
        name: 'Design System',
        status: 'active',
        description: 'Tokens, typography, spacing standards',
      },
    ...
    features: [
      {
        ...
        status: 'active',
        description: 'Proactive legal issue identification',
      },
      {
      ...
      {
        name: 'Dispute Prevention',
        status: 'active',
        description: 'Early warning system for conflicts',
      },
      {
        name: 'Best Practices Library',
        status: 'active',
        description: 'Legal templates and guidelines',
      },
      {
        name: 'Clause Analysis',
        status: 'active',
        description: 'AI-powered contract clause review',
      },
    ],
    roadmap: [
  ...
  sentinel: {
    overview:
      'Property Monitoring AI with IoT integration, predictive maintenance, and emergency response',
    phase: 'Production',
    version: '1.1',
    features: [
      ...
      },
      {
        ...
        status: 'active',
        description: 'Automated inspection scheduling',
      },
      {
        name: 'Vendor Management',
        status: 'active',
        description: 'Contractor database and dispatch',
      },
      { name: 'Emergency Response', status: 'active', description: '24/7 emergency coordination' },
      {
        name: 'Work Order System',
        status: 'active',
        description: 'Maintenance work order tracking',
      },
    ],
    roadmap: [
    ...
    features: [
      {
        ...
        status: 'active',
        description: 'Identify high-potential prospects',
      },
      {
        name: 'Market Scanning',
        status: 'active',
        description: 'Monitor listing portals for opportunities',
      },
      {
        name: 'Pattern Detection',
        status: 'active',
        description: 'Buying/selling pattern recognition',
      },
      { name: 'Outreach Campaigns', status: 'active', description: 'Automated prospect outreach' },
      {
        name: 'Lead Enrichment',
        status: 'active',
        description: 'Enhance lead data with external sources',
      },
  ...
  henry: {
    overview:
      'Record Keeper & Timeline Master creating immutable audit trails and compliance reports',
    phase: 'Production',
    version: '1.0',
    features: [
      {
      ...
      { name: 'Audit Log', status: 'active', description: 'Immutable action records' },
      {
        ...
        status: 'active',
        description: 'Pattern analysis across events',
      },
      {
  ...
  cipher: {
    overview:
      'Predictive Market Analyst using DLD data and economic indicators for property valuation',
    phase: 'Production',
    version: '1.0',
    features: [
      { name: 'Market Trends', status: 'active', description: 'Real-time market trend analysis' },
      {
        ...
        status: 'active',
        description: 'AI-powered valuation forecasts',
      },
      { name: 'Competitor Tracking', status: 'active', description: 'Monitor competitor activity' },
      {
        name: 'Economic Indicators',
        status: 'active',
        description: 'Track macro-economic factors',
      },
  ...
  atlas: {
    overview:
      'Development & Project Intelligence for off-plan projects, zoning, and developer tracking',
    phase: 'Production',
    version: '1.0',
    features: [
      { name: 'Project Pipeline', status: 'active', description: 'Track upcoming developments' },
      {
        ...
        status: 'active',
        description: 'ROI and viability assessments',
      },
      {
        name: 'Developer Tracking',
        status: 'active',
        description: 'Developer reputation database',
      },
      { name: 'Zoning Analysis', status: 'active', description: 'Land use and zoning maps' },
      {
        name: 'Market Gap Detection',
        status: 'active',
        description: 'Identify underserved markets',
      },
  ...
  vesta: {
    overview:
      'Project & Snagging Coordinator tracking construction milestones and handover processes',
    phase: 'Production',
    version: '1.0',
    features: [
      {
        ...
        status: 'active',
        description: 'Construction progress monitoring',
      },
      ...
      { name: 'Defect Reporting', status: 'active', description: 'Photo-based defect logging' },
      {
        ...
        status: 'active',
        description: 'Automated developer updates',
      },
      {
        name: 'Image Recognition',
        status: 'active',
        description: 'AI defect detection from photos',
      },
    ],
    roadmap: [
  ...
  kairos: {
    ...
    features: [
      { name: 'VIP Client Manager', status: 'active', description: 'Premium client database' },
      {
        ...
        status: 'active',
        description: 'Personalized service coordination',
      },
      {
        name: 'Lifestyle Coordination',
        status: 'active',
        description: 'Interior design, relocation services',
      },
      {
        name: 'Partner Network',
        status: 'active',
        description: 'Premium service provider directory',
      },
      {
        name: 'Exclusive Access',
        status: 'active',
        description: 'Early access to premium listings',
      },
      {
  ...
  maven: {
    overview:
      'Investment Strategy & Portfolio Optimizer analyzing yields and providing investment advice',
    phase: 'Production',
    version: '1.0',
    features: [
      {
        ...
        status: 'active',
        description: 'Multi-property portfolio tracking',
      },
      ...
      { name: 'Risk Assessment', status: 'active', description: 'Investment risk scoring' },
      {
        ...
        status: 'active',
        description: 'ROI and appreciation tracking',
      },
    ],
    roadmap: [
