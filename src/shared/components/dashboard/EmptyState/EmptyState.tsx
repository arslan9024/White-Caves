...
type RoleType = 'buyer' | 'seller' | 'landlord' | 'tenant' | 'leasing-agent' | 'secondary-sales-agent' | 'owner' | 'default';

type EmptyStateType = 'properties' | 'appointments' | 'leads' | 'contracts' | 'transactions' | 'messages' | 'default';
...
const ROLE_ILLUSTRATIONS: Record<RoleType, RoleIllustration> = {
...
const DEFAULT_MESSAGES: Record<EmptyStateType, DefaultMessage> = {
  properties: {
    ...
    <div className={`empty-state ${compact ? 'compact' : ''} ${className}`}>
      <div className="empty-state-content">
        <div 
          ...
          style={{ '--accent-color': roleConfig.color } as React.CSSProperties}
        >
