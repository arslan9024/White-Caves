...
const PropertyFilters = React.memo<PropertyFiltersProps>(({
  filters = {},
  onFilterChange,
  onApply,
  onReset,
  ...
  const [localFilters, setLocalFilters] = useState<PropertyFilterValues>(filters);
  const [showAdvancedFilters, setShowAdvancedFilters] = useState<boolean>(showAdvanced);

  const handleChange = useCallback((field: string, value: string): void => {
    const updated: PropertyFilterValues = { ...localFilters, [field]: value };
    ...
    <div className={classes}>
      ...
      >
        <Select
          ...
          onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChange('propertyType', e.target.value)}
        ...
        <Select
          ...
          onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChange('bedrooms', e.target.value)}
          size={compact ? 'small' : 'medium'}
          fullWidth
        />
        ...
        <Select
          ...
          onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChange('priceRange', e.target.value)}
          size={compact ? 'small' : 'medium'}
          fullWidth
        />
      ...
      {showAdvancedFilters && (
        ...
        >
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('minArea', e.target.value)}
            size={compact ? 'small' : 'medium'}
            fullWidth
          />
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('maxArea', e.target.value)}
            size={compact ? 'small' : 'medium'}
            fullWidth
          />
          ...
          <Select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChange('furnishing', e.target.value)}
            size={compact ? 'small' : 'medium'}
            fullWidth
          />
          ...
          <Select
            ...
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChange('availability', e.target.value)}
            size={compact ? 'small' : 'medium'}
            fullWidth
          />
        </Grid>
