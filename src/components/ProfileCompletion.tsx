...
interface ProfileCompletionProps {
  ...
  token: string;
  onComplete: (user: ProfileCompletionUser, token: string) => void;
  onSkip: () => void;
}
...
const ProfileCompletion: React.FC<ProfileCompletionProps> = ({ user, token, onComplete, onSkip }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      const data: ProfileCompletionResponse = await response.json();
