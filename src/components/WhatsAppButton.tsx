...
export default function WhatsAppButton() {
  const phoneNumber = Config.COMPANY.WHATSAPP || '+971505110636';
  const message = encodeURIComponent(
    'Hello! I would like to inquire about White Caves Real Estate services.'
  );
  ...
  return (
    <WhatsAppFloatingBtn onClick={handleWhatsAppClick} aria-label="Chat on WhatsApp">
