...
export const RunButton = styled.button<{ $isRunning: boolean }>`
  background: ${props => props.$isRunning ? 'var(--color-94a3b8, #94A3B8)' : 'var(--color-10b981, #10B981)'};
  ...
  &:hover {
    background: ${props => props.$isRunning ? 'var(--color-94a3b8, #94A3B8)' : 'var(--color-059669, #059669)'};
  }
`;
