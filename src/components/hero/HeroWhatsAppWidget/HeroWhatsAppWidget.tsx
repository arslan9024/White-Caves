...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroWhatsAppWidget.style';
import { useHeroWhatsAppLogic } from './HeroWhatsAppWidget.logic';
import { MessageCircle } from 'lucide-react';
export const HeroWhatsAppWidget: React.FC = () => {
  const { t, isRtl } = useHeroWhatsAppLogic();
