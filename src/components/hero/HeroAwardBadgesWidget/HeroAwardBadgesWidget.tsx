...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroAwardBadgesWidget.style';
import { useHeroAwardBadgesLogic } from './HeroAwardBadgesWidget.logic';
import { Award } from 'lucide-react';
export const HeroAwardBadgesWidget: React.FC = () => {
  const { t, isRtl } = useHeroAwardBadgesLogic();
