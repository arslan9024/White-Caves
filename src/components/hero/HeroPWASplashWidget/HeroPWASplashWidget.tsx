...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroPWASplashWidget.style';
import { useHeroPWASplashLogic } from './HeroPWASplashWidget.logic';
import { Smartphone } from 'lucide-react';
export const HeroPWASplashWidget: React.FC = () => {
  const { t, isRtl } = useHeroPWASplashLogic();
