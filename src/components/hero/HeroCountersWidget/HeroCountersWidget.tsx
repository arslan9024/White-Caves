...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroCountersWidget.style';
import { useHeroCountersLogic } from './HeroCountersWidget.logic';
import { Hash } from 'lucide-react';
export const HeroCountersWidget: React.FC = () => {
  const { t, isRtl } = useHeroCountersLogic();
