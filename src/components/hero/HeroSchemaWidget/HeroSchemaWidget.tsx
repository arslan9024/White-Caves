...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroSchemaWidget.style';
import { useHeroSchemaLogic } from './HeroSchemaWidget.logic';
import { Code2 } from 'lucide-react';
export const HeroSchemaWidget: React.FC = () => {
  const { t, isRtl } = useHeroSchemaLogic();
