...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroUnitTestWidget.style';
import { useHeroUnitTestLogic } from './HeroUnitTestWidget.logic';
import { FlaskConical } from 'lucide-react';
export const HeroUnitTestWidget: React.FC = () => {
  const { t, isRtl } = useHeroUnitTestLogic();
