...
import { WidgetContainer, InfoGrid, InfoCard } from './HeroHeatMapWidget.style';
import { useHeroHeatMapLogic } from './HeroHeatMapWidget.logic';
import { Map } from 'lucide-react';
export const HeroHeatMapWidget: React.FC = () => {
  const { t, isRtl } = useHeroHeatMapLogic();
