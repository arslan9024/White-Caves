...
interface ActivityItem {
  id: number;
  type: 'view' | 'favorite' | 'search' | 'appointment';
  description: string;
  date: string;
}
...
const Profile: React.FC<ProfileProps> = ({ user, onLogout }) => {
  ...
  const loginMethods: LoginMethod[] = user.providerData?.map((provider) => ({
  ...
  const removeSavedSearch = (id: number): void => {
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmailData({...emailData, password: e.target.value})}
