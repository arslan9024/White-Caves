...
const INITIAL_AI_MESSAGES: ChatMessage[] = [
  {
    role: 'assistant',
    content: "Hi! I'm Zoe, your AI property assistant. How can I help you today? 🏠",
  },
];
  ...
  const quickMessages: QuickMessage[] = [
    {
      ...
      message: 'Hello! I would like to inquire about a property.',
    },
    {
      id: 2,
      text: 'Schedule Viewing',
      message: 'Hi! I would like to schedule a property viewing.',
    },
    { id: 3, text: 'Rental Information', message: 'Hello! I am interested in rental properties.' },
    {
      id: 4,
      text: 'Investment Advice',
      message: 'Hi! I would like to discuss investment opportunities.',
    },
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" width="24" height="24">
          ...
          <path
            fill="white"
            d="M17 8H7c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h8l4 4V10c0-1.1-.9-2-2-2zm-1 6H8v-1h8v1zm0-2H8v-1h8v1z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="white" strokeWidth="2">
          <circle cx="12" cy="12" r="12" fill="#E31E24" stroke="none" />
          <path
    ...
    <ClickToChatContainer>
      ...
      {isExpanded && (
        <ChatPopup
          ...
          role="dialog"
          aria-modal="true"
          aria-label="White Caves chat support"
        >
          <ChatHeader>
            <ChatHeaderInfo>
            ...
            >
              <button
                ...
                style={{
                  ...
                  fontSize: '0.85rem',
                  background: 'none',
                  borderBottom: activeTab === 'ai' ? '2px solid #E31E24' : '2px solid transparent',
                  color: activeTab === 'ai' ? '#E31E24' : '#6b7280',
                  transition: 'all 0.2s',
                }}
              ...
              <button
                ...
                style={{
                  ...
                  background: 'none',
                  borderBottom:
                    activeTab === 'contact' ? '2px solid #25D366' : '2px solid transparent',
                  color: activeTab === 'contact' ? '#25D366' : '#6b7280',
                  transition: 'all 0.2s',
                }}
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor: aiInput.trim() && !isAiTyping ? 'pointer' : 'not-allowed',
                      flexShrink: 0,
              ...
              <>
                ...
                <QuickMessages>
                  ...
                  {quickMessages.map(item => (
                    <QuickMessageBtn key={item.id} onClick={() => handleQuickMessage(item.message)}>
                      {item.text}
                    </QuickMessageBtn>
                  ))}
                </QuickMessages>
