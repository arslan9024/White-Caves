  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const [l, m] = await settledJson([authFetch('/api/leases/my-lease'), authFetch('/api/maintenance?pageSize=5')],
          [{ data: null }, { data: [] }],
        ) as any[];
        setLease(l.data);
      ...
      <div style={S.card}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
          ...
          <div>
            ...
            <p style={S.headerSubtitle}>{S.formatCurrency(lease.securityDeposit ?? 0)}</p>
          </div>
          <div>
