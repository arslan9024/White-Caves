/**
 * AegisAutopilotHub.style.ts
 * Styled-Components for AEGIS Autopilot Hub
 * Brand Accent: #EF4444 (White Caves Red) | #3B82F6 (Electric Blue) | #10B981 (Emerald)
 */
...
export const HeaderBanner = styled.div`
  background: linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(59, 130, 246, 0.12) 50%, rgba(30, 41, 59, 0.6) 100%);
...
export const CategoryPill = styled.button<{ $active: boolean }>`
  ...
  font-size: 0.8rem;
  font-weight: 700;
  border: 1px solid ${(p) => (p.$active ? 'var(--accent-red, #ef4444)' : 'rgba(255, 255, 255, 0.1)')};
  background: ${(p) => (p.$active ? 'var(--accent-red, #ef4444)' : 'rgba(30, 41, 59, 0.6)')};
  color: var(--white, #ffffff);
  cursor: pointer;
  transition: all 0.2s;

  &:hover {
    background: ${(p) => (p.$active ? '#dc2626' : 'rgba(239, 68, 68, 0.15)')};
  }
`;
...
export const ActionButton = styled.button<{ $variant?: 'primary' | 'secondary' }>`
  ...
  font-weight: 700;
  cursor: pointer;
  border: 1px solid ${(p) => (p.$variant === 'primary' ? '#ef4444' : '#cbd5e1')};
  background: ${(p) => (p.$variant === 'primary' ? '#ef4444' : '#ffffff')};
  color: ${(p) => (p.$variant === 'primary' ? '#ffffff' : '#1e293b')};
  transition: all 0.2s;

  &:hover {
    background: ${(p) => (p.$variant === 'primary' ? '#dc2626' : '#f1f5f9')};
  }
`;
