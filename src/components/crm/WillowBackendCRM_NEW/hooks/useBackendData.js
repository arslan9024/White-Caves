...
import { API_ENDPOINTS, DATABASE_METRICS, CACHE_STATS, SECURITY_CHECKS, REALTIME_CONNECTIONS } from '../data/backend';
...
export const useBackendData = () => {
  ...
  const [securityChecks, setSecurityChecks] = useState(SECURITY_CHECKS);
  const [realtimeConnections, setRealtimeConnections] = useState(REALTIME_CONNECTIONS);
