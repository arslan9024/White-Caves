/**
 * AdaArchitectureHub.style.ts
 * Styled-Components for Ada Chief Architecture & SDLC Hub
 * Accent Color: #10B981 (Emerald Green) | #6366F1 (Indigo)
 */
...
export const HeaderBanner = styled.div`
  background: linear-gradient(135deg, rgba(16, 185, 129, 0.12) 0%, rgba(30, 41, 59, 0.5) 100%);
...
export const CategoryPill = styled.button<{ $active: boolean }>`
  ...
  font-size: 0.8rem;
  font-weight: 700;
  border: 1px solid ${(p) => (p.$active ? '#10b981' : 'rgba(255, 255, 255, 0.1)')};
  background: ${(p) => (p.$active ? '#10b981' : 'rgba(30, 41, 59, 0.6)')};
  color: ${(p) => (p.$active ? '#0f172a' : '#ffffff')};
  cursor: pointer;
  transition: all 0.2s;

  &:hover {
    background: ${(p) => (p.$active ? '#059669' : 'rgba(16, 185, 129, 0.15)')};
  }
`;
...
export const ActionButton = styled.button<{ $variant?: 'primary' | 'secondary' }>`
  ...
  font-weight: 700;
  cursor: pointer;
  border: 1px solid ${(p) => (p.$variant === 'primary' ? '#10b981' : '#cbd5e1')};
  background: ${(p) => (p.$variant === 'primary' ? '#10b981' : '#ffffff')};
  color: ${(p) => (p.$variant === 'primary' ? '#ffffff' : '#1e293b')};
  transition: all 0.2s;

  &:hover {
    background: ${(p) => (p.$variant === 'primary' ? '#059669' : '#f1f5f9')};
  }
`;
