...
import { Briefcase, ClipboardCheck, Wrench, Book, CheckCircle2 } from 'lucide-react';
...
const RECENT_ACTIVITIES = [
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'Ethan',
    action: 'assigned vendor for',
    target: 'AC Maintenance',
  ...
  },
  {
    ...
    actor: 'Vendor',
    action: 'completed',
    target: 'Painting Service',
    timestamp: '2 hours ago',
    type: 'success',
  },
];

export default function ServicesMixedDashboard({
  _subItem = 'service-catalog',
  selectedAssistant,
}) {
  ...
  return (
    <MixedDashboard
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  property: 'Downtown 3BR',
                  vendor: 'CoolAir',
                  status: 'Assigned',
                },
                {
                  service: 'Move-out Inspection',
                  property: 'JBR Studio',
                  vendor: 'Internal',
                  status: 'Requested',
                },
      ...
      activityComponent={
        <LiveActivityFeed activities={RECENT_ACTIVITIES} title="Service Activity" />
      }
