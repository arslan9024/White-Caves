...
import { TrendingUp, FileBarChart, Award, Zap } from 'lucide-react';
...
const RECENT_ACTIVITIES = [
  {
    ...
    icon: 'success',
    actor: 'Coral',
    action: 'generated market analysis for',
    target: 'Palm Jumeirah',
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'Celeste',
    action: 'predicted Q1 2026 trends',
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'Sage',
    action: 'identified pricing opportunity in',
    target: 'Downtown',
  ...
  },
  {
    ...
    icon: 'success',
    actor: 'System',
    action: 'completed weekly dashboard update',
    timestamp: '3 hours ago',
    type: 'success',
  },
];

export default function AnalyticsMixedDashboard({
  _subItem = 'market-dashboard',
  selectedAssistant,
}) {
  ...
  return (
    <MixedDashboard
      ...
      tableComponent={
        <DashboardSection title="Recent Reports" icon={<FileBarChart size={18} />}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {[
              {
                name: 'Dubai Market Q4 2025',
                type: 'Market Analysis',
                date: 'Jan 10, 2026',
                status: 'Published',
              },
              {
                name: 'Sales Performance Dec',
                type: 'Performance',
                date: 'Jan 8, 2026',
                status: 'Published',
              },
              {
                name: 'Rental Yield Comparison',
                type: 'Investment',
                date: 'Jan 5, 2026',
                status: 'Published',
              },
      ...
      activityComponent={
        <LiveActivityFeed activities={RECENT_ACTIVITIES} title="Analytics Activity" />
      }
