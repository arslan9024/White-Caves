...
import { Rocket, MessageCircle, Users, TrendingUp } from 'lucide-react';
...
const RECENT_ACTIVITIES = [
  ...
  },
  {
    ...
    icon: 'message',
    actor: 'Iris',
    action: 'sent WhatsApp blast to',
    target: '2,500 contacts',
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'System',
    action: 'tracked 89 new leads from',
    target: 'Google Ads',
...
export default function MarketingMixedDashboard({ _subItem = 'campaigns', selectedAssistant }) {
  ...
  return (
    <MixedDashboard
          ...
          >
            {[
              ...
              >
                ...
                >
                  <span>
                    <strong style={{ color: '#B03737' }}>{campaign.leads}</strong> leads
                  </span>
      ...
      activityComponent={
        <LiveActivityFeed activities={RECENT_ACTIVITIES} title="Marketing Activity" />
      }
