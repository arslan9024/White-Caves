...
import { Shield, CheckCircle, UserCheck, AlertTriangle } from 'lucide-react';
...
const RECENT_ACTIVITIES = [
  ...
  },
  {
    ...
    icon: 'warning',
    actor: 'Jack',
    action: 'flagged AML concern for',
    target: 'Transaction #T892',
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'Henry',
    action: 'verified RERA documents for',
    target: 'Palm Villa Listing',
  ...
  },
  {
    ...
    icon: 'document',
    actor: 'System',
    action: 'generated audit report for',
    target: 'Q4 2025',
...
export default function ComplianceMixedDashboard({ _subItem = 'kyc-aml', selectedAssistant }) {
  ...
  return (
    <MixedDashboard
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  type: 'Tenant',
                  docs: 'Visa, Salary Cert.',
                  status: 'Initiated',
                },
                {
                  client: 'James Wilson',
                  type: 'Investor',
                  docs: 'Bank Statement, POA',
                  status: 'Flagged',
                },
              ].map((item, i) => (
      ...
      activityComponent={
        <LiveActivityFeed activities={RECENT_ACTIVITIES} title="Compliance Activity" />
      }
