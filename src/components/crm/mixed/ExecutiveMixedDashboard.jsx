...
import { DollarSign, Users, Building, Target, BarChart3 } from 'lucide-react';
...
const RECENT_ACTIVITIES = [
  ...
  },
  {
    ...
    icon: 'user',
    actor: 'HR',
    action: 'onboarded 3 new team members to',
    target: 'Sales Dept',
  ...
  },
  {
    ...
    icon: 'success',
    actor: 'Ella',
    action: 'closed largest deal:',
    target: 'AED 25M Palm Villa',
    timestamp: 'Yesterday',
    type: 'success',
  },
  {
    ...
    icon: 'ai',
    actor: 'Coral',
    action: 'published market analysis report',
    timestamp: 'Yesterday',
    type: 'default',
  },
];
...
const DEPARTMENT_PERFORMANCE = [
  { name: 'Sales', progress: 92, target: 'AED 15M', actual: 'AED 13.8M', color: '#10B981' },
  {
    name: 'Leasing',
    progress: 87,
    target: '350 contracts',
    actual: '305 contracts',
    color: '#3B82F6',
  },
...
export default function ExecutiveMixedDashboard({ _subItem = 'md-dashboard', selectedAssistant }) {
    ...
    <MixedDashboard
      ...
      flowchartComponent={
        <div>
          ...
          <LifecycleFlowchart stages={COMPANY_LIFECYCLE} currentStage={3} stageData={STAGE_DATA} />
        </div>
      }
      tableComponent={
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontSize: '0.75rem',
                    color:
                      dept.progress >= 90 ? '#10B981' : dept.progress >= 75 ? '#F59E0B' : '#EF4444',
                    fontWeight: 600,
                  }}
                >
      ...
      activityComponent={
        <LiveActivityFeed activities={RECENT_ACTIVITIES} title="Company Activity" />
      }
