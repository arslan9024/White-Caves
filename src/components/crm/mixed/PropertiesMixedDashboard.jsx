...
import { Home, Building, Grid3X3, ListPlus, Workflow } from 'lucide-react';
...
const RECENT_ACTIVITIES = [
  {
    ...
    icon: 'success',
    actor: 'Mary',
    action: 'added 12 properties from',
    target: 'DAMAC Hills',
    timestamp: '5 min ago',
    type: 'success',
  },
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'Sam',
    action: 'generated virtual tour for',
    target: 'JBR Penthouse',
...
export default function PropertiesMixedDashboard({ _subItem = 'portfolio', selectedAssistant }) {
  ...
  return (
    <MixedDashboard
            ...
            {FEATURED_PROPERTIES.map(property => (
              ...
              >
                ...
                <div style={{ padding: '14px' }}>
                  <h5 style={{ margin: '0 0 6px 0', fontSize: '0.9rem', fontWeight: 600 }}>
                    {property.title}
                  </h5>
                  <p
                    style={{ margin: '0 0 8px 0', fontSize: '0.75rem', color: 'var(--text-muted)' }}
                  >
                  ...
                  >
                    <span style={{ fontSize: '0.95rem', fontWeight: 700, color: '#B03737' }}>
                      {property.price}
                    </span>
                    <span
                      style={{
      ...
      activityComponent={
        <LiveActivityFeed activities={RECENT_ACTIVITIES} title="Inventory Activity" />
      }
