...
const RECENT_ACTIVITIES = [
  ...
  },
  {
    ...
    icon: 'ai',
    actor: 'Ella',
    action: 'auto-scored 12 new leads',
  ...
  },
  {
    ...
    icon: 'message',
    actor: 'System',
    action: 'scheduled follow-up for',
    target: '8 leads',
...
export default function SalesMixedDashboard({ _subItem = 'leads', selectedAssistant }) {
