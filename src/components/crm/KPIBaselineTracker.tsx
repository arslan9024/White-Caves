...
const STATIC_KPIS: KPI[] = [
  ...
  { name: 'Listing Completeness',     target: '90%',       targetNum: 90,  current: 62,  unit: '%',    trend: '↑', higherIsBetter: true  },
  { name: 'Mobile CRM Sessions',      target: '60%',       targetNum: 60,  current: 31,  unit: '%',    trend: '↑', higherIsBetter: true  },
  { name: 'Tenant Portal MAU',        target: '200 users', targetNum: 200, current: 45,  unit: ' users', trend: '↑', higherIsBetter: true },
  { name: 'Organic Leads Share',      target: '40%',       targetNum: 40,  current: 22,  unit: '%',    trend: '↑', higherIsBetter: true  },
  { name: 'UX Regressions',           target: '0',         targetNum: 0,   current: 3,   unit: '',     trend: '↓', higherIsBetter: false },
];
