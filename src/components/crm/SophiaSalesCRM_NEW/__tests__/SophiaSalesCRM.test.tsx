...
vi.mock('../tabs/PipelineTab', () => ({
  default: (props: any) => <div data-testid="pipeline-tab">Pipeline Tab - Stage: {props.selectedStage}</div>,
}));

vi.mock('../tabs/DealsTab', () => ({
  default: (props: any) => <div data-testid="deals-tab">Deals Tab - Query: {props.searchQuery}</div>,
}));

vi.mock('../tabs/AgentsTab', () => ({
  default: (props: any) => <div data-testid="agents-tab">Agents Tab - Count: {props.agents?.length}</div>,
}));
...
describe('SophiaSalesCRM', () => {
  const defaultHookReturn = {
    ...
    deals: [
      { id: 1, property: 'Villa 1', client: 'Client A', value: 1000000, stage: 'qualification', agent: 'Agent1' },
      { id: 2, property: 'Villa 2', client: 'Client B', value: 2000000, stage: 'negotiation', agent: 'Agent2' },
    ],
    filteredDeals: [
      { id: 1, property: 'Villa 1', client: 'Client A', value: 1000000, stage: 'qualification', agent: 'Agent1' },
    ],
