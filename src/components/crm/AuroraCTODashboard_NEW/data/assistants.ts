...
export const AI_ASSISTANTS_REGISTRY: AIAssistant[] = [
  { id: 'nadia', name: 'Nadia', title: 'WhatsApp CRM Manager', department: 'Communications', status: 'active', features: ['23+ Agent Management', 'Conversation Routing', 'Lead Pre-qualification', 'Template Messaging', 'Performance Tracking'], connections: ['Clara', 'Sophia'] },
  ...
  { id: 'clara', name: 'Clara', title: 'Leads CRM Manager', department: 'Sales', status: 'active', features: ['Lead Pipeline Management', 'Qualification Workflows', 'Conversion Tracking', 'Lead Scoring', 'Auto-Assignment'], connections: ['Nadia', 'Sophia', 'Nancy'] },
  { id: 'nina', name: 'Nina', title: 'WhatsApp Bot Developer', department: 'Communications', status: 'active', features: ['Bot Flow Design', 'Session Management', 'Analytics Dashboard', 'Template Builder', 'Webhook Configuration'], connections: ['Nadia', 'Aurora'] },
