...
export const DUMMY_CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: 2,
        type: 'sent',
        text: 'Hi Mohammed! Which property are you interested in?',
        time: '10:32 AM',
        status: 'read',
      },
      {
        id: 3,
        type: 'received',
        text: 'The 3BR apartment in Dubai Marina',
        time: '10:33 AM',
        status: 'read',
      },
      {
      ...
      },
      {
        id: 5,
        type: 'ai',
        text: 'Nadia AI: This lead shows high buying intent. Recommend scheduling a viewing within 24 hours.',
        time: '10:34 AM',
      },
      {
        id: 6,
        type: 'received',
        text: 'I am interested in the Marina apartment',
        time: '10:35 AM',
        status: 'delivered',
      },
    ],
    ...
    messages: [
      {
        id: 1,
        type: 'received',
        text: 'Hi, I need a 2BR apartment for rent',
        time: '9:00 AM',
        status: 'read',
      },
      {
        id: 2,
        type: 'sent',
        text: 'Hello Sarah! We have several options. What is your budget?',
        time: '9:05 AM',
        status: 'read',
      },
    ...
    messages: [
      {
        id: 1,
        type: 'received',
        text: 'Looking for investment properties',
        time: '7:00 AM',
        status: 'read',
      },
      {
        id: 2,
        type: 'sent',
        text: 'We have great ROI properties in Business Bay',
        time: '7:30 AM',
        status: 'read',
      },
      {
        id: 3,
        type: 'received',
        text: 'Thank you, will get back to you',
        time: '8:00 AM',
        status: 'read',
      },
    ],
