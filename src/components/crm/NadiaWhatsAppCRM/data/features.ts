// Nadia WhatsApp CRM feature catalog
...
export const NADIA_WHATSAPP_FEATURES: WhatsAppFeature[] = [
  {
    id: 'ai-messaging',
    name: 'AI-Powered Messaging',
    description: 'Nadia AI provides intelligent responses and lead scoring',
