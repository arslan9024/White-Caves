...
export const InsightsTab = ({ data }) => {
  ...
  const hotLeadsCount = conversations.filter(c => c.priority === 'hot').length;
  const warmLeadsCount = conversations.filter(c => c.priority === 'warm').length;
    ...
    <div className="insights-tab">
      ...
      <div className="insights-section">
        ...
        <div className="distribution-chart">
          <div className="distribution-bar hot" style={{ width: `${(hotLeadsCount / totalConversations) * 100}%` }}>
            <span>{hotLeadsCount} Hot</span>
          </div>
          <div className="distribution-bar warm" style={{ width: `${(warmLeadsCount / totalConversations) * 100}%` }}>
            <span>{warmLeadsCount} Warm</span>
          </div>
          <div className="distribution-bar cold" style={{ width: `${((totalConversations - hotLeadsCount - warmLeadsCount) / totalConversations) * 100}%` }}>
