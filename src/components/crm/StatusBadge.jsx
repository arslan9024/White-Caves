...
const STATUS_CONFIGS = {
  ...
  in_progress: { label: 'In Progress', color: '#EF4444', bg: 'rgba(59, 130, 246, 0.1)' },
  available: { label: 'Available', color: '#059669', bg: 'rgba(5, 150, 105, 0.1)' },
  sold: { label: 'Sold', color: '#EF4444', bg: 'rgba(99, 102, 241, 0.1)' },
  ...
  cold: { label: 'Cold', color: '#EF4444', bg: 'rgba(59, 130, 246, 0.1)' },
  ...
  new: { label: 'New', color: '#EF4444', bg: 'rgba(99, 102, 241, 0.1)' },
  contacted: { label: 'Contacted', color: '#EF4444', bg: 'rgba(59, 130, 246, 0.1)' },
  ...
  review: { label: 'Review', color: '#EF4444', bg: 'rgba(59, 130, 246, 0.1)' }
};
