        ...
        <form onSubmit={handleAddLead} style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
            <input
              ...
              value={formData.name}
              onChange={(e) => setField('name' as any, e.target.value as any)}
            ...
            <select
              value={formData.type}
              onChange={(e) => setField('type' as any, e.target.value as any)}
            ...
            <select
              value={formData.size}
              onChange={(e) => setField('size' as any, e.target.value as any)}
              className="filter-select"
            >
            ...
            <input
              ...
              onChange={(e) => setField('email' as any, e.target.value as any)}
              className="filter-input"
            />
            <input
              type="tel"
              ...
              onChange={(e) => setField('phone' as any, e.target.value as any)}
              className="filter-input"
            />
            <input
              type="number"
              ...
              onChange={(e) => {
                ...
                setField('value' as any, Number.isNaN(parsed as any) ? 0 : parsed);
              }}
              className="filter-input"
            />
            <select
              value={formData.status}
              onChange={(e) => setField('status' as any, e.target.value as any)}
              className="filter-select"
            >
            ...
            <select
              ...
              onChange={(e) => setField('stage' as any, e.target.value as any)}
              className="filter-select"
            >
            ...
            <textarea
              ...
              onChange={(e) => setField('notes' as any, e.target.value as any)}
              className="filter-input"
