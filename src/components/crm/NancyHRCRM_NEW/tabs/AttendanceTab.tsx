...
export default function AttendanceTab({ state }) {
    ...
    <div className="attendance-view">
      <div className="view-header">
        ...
        <div className="header-actions">
          <input type="month" defaultValue={new Date().toISOString().slice(0, 7)} className="month-select" />
      ...
      <div className="attendance-stats">
        <div className="attendance-card">
          ...
          <div className="stat-info">
            <span className="stat-value">{employees.filter(e => e.attendance >= 95).length}</span>
        ...
        <div className="attendance-card">
          <AlertCircle size={20} />
          <div className="stat-info">
            <span className="stat-value">{employees.filter(e => e.attendance < 90).length}</span>
        ...
        <div className="attendance-card">
          <Calendar size={20} />
          <div className="stat-info">
            <span className="stat-value">{employees.reduce((sum, e) => sum + e.leaveBalance, 0)}</span>
