...
vi.mock('./DataGridView.styles', () => ({
  ...
  GridFilterButton: ({ children, ...p }: React.PropsWithChildren<{ type?: string }>) => <button {...p}>{children}</button>,
  ...
  RowActionsButton: ({ children, ...p }: React.PropsWithChildren<{ type?: string; 'aria-label'?: string }>) => <button {...p}>{children}</button>,
  ...
  PaginationButton: ({ children, ...p }: React.PropsWithChildren<{ disabled?: boolean; onClick?: () => void; type?: string }>) => <button {...p}>{children}</button>,
