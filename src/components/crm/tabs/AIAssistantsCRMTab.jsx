...
const AI_ASSISTANTS = [
  {
    ...
    accuracy: 98,
    color: '#10B981',
    description: 'Strategic decisions and executive support',
  },
  {
    id: 'mary',
    name: 'Mary',
    ...
    accuracy: 96,
    color: '#3B82F6',
    description: 'Property inventory and availability tracking',
  },
  {
    id: 'clara',
    name: 'Clara',
    ...
    accuracy: 94,
    color: '#8B5CF6',
    description: 'Lead scoring, qualification, and routing',
  },
  {
    id: 'linda',
    name: 'Linda',
    ...
    accuracy: 97,
    color: '#25D366',
    description: 'WhatsApp automation and customer support',
  },
  {
    id: 'nina',
    name: 'Nina',
    ...
    accuracy: 95,
    color: '#06B6D4',
    description: 'Website chatbot and AI conversations',
  },
  {
    id: 'nancy',
    name: 'Nancy',
    ...
    accuracy: 92,
    color: '#A855F7',
    description: 'Recruitment, onboarding, and HR support',
  },
  {
    id: 'sophia',
    name: 'Sophia',
    ...
    accuracy: 93,
    color: '#EC4899',
    description: 'Deal negotiation and contract preparation',
  },
  {
    id: 'daisy',
    name: 'Daisy',
    ...
    accuracy: 95,
    color: '#F59E0B',
    description: 'Tenancy management and renewals',
  },
  {
    id: 'theodora',
    name: 'Theodora',
  ...
  },
  {
    ...
    accuracy: 97,
    color: '#0EA5E9',
    description: 'Technical strategy and system monitoring',
  },
  {
    id: 'hazel',
    name: 'Hazel',
    ...
    accuracy: 94,
    color: '#14B8A6',
    description: 'UI/UX improvements and frontend tasks',
  },
  {
    id: 'willow',
    name: 'Willow',
  ...
  },
  {
    ...
    accuracy: 98,
    color: '#DC2626',
    description: 'Contract review and legal guidance',
  },
  {
    id: 'sentinel',
    name: 'Sentinel',
  ...
  },
  {
    ...
    accuracy: 99,
    color: '#4338CA',
    description: 'Internal auditing and compliance checks',
  },
  {
    id: 'cipher',
    name: 'Cipher',
  ...
  },
  {
    ...
    accuracy: 92,
    color: '#0891B2',
    description: 'Project tracking and resource allocation',
  },
  {
    id: 'vesta',
    name: 'Vesta',
    ...
    accuracy: 96,
    color: '#059669',
    description: 'Property handover and documentation',
  },
  {
    id: 'juno',
    name: 'Juno',
    ...
    accuracy: 93,
    color: '#DB2777',
    description: 'Community engagement and social media',
  },
  {
    id: 'kairos',
    name: 'Kairos',
    ...
    accuracy: 97,
    color: '#E31E24',
    description: 'Ultra-luxury property transactions',
  },
  {
    id: 'maven',
    name: 'Maven',
    ...
    accuracy: 98,
    color: '#B45309',
    description: 'Investment analysis and portfolio advice',
  },
];
...
export default function AIAssistantsCRMTab() {
  ...
  const [_selectedAssistant, setSelectedAssistant] = useState(null);
