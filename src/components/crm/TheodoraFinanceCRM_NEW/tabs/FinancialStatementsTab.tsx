...
export const FinancialStatementsTab: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      {/* Sub-Navigation Bar */}
      <div style={{ display: 'flex', gap: '0.5rem', background: 'var(--color-f1f5f9, #F1F5F9)', padding: '4px', borderRadius: '10px', width: 'fit-content' }}>
        <button
      ...
      {statementType === 'pnl' && (
        <div style={{ background: 'var(--white, #FFFFFF)', borderRadius: '12px', border: '1px solid var(--text-secondary, #E2E8F0)', padding: '1.5rem' }}>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
            <tbody>
              <tr style={{ background: 'var(--color-f8fafc, #F8FAFC)', fontWeight: 800, color: 'var(--color-1e293b, #1E293B)' }}>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 4010</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 4020</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 4030</td>
                <td style={{ padding: '8px 12px', textAlign: 'right', fontWeight: 700 }}>120,000.00</td>
              </tr>
              <tr style={{ background: 'var(--color-f1f5f9, #F1F5F9)', fontWeight: 800 }}>
                <td style={{ padding: '10px 12px' }} colSpan={2}>TOTAL REVENUE</td>
                <td style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--accent-green, #10B981)' }}>1,850,000.00</td>
              </tr>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 5010-5080</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 6010-6090</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 7010-7100</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 8010-8060</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 9010-9060</td>
              ...
              <tr style={{ borderBottom: '1px solid var(--color-f1f5f9, #F1F5F9)' }}>
                ...
                <td style={{ padding: '8px 12px', color: 'var(--text-secondary, #64748B)' }}>Acct 5000</td>
              ...
              <tr style={{ background: 'var(--color-f1f5f9, #F1F5F9)', fontWeight: 800 }}>
                ...
                <td style={{ padding: '10px 12px', textAlign: 'right', color: 'var(--accent-red, #EF4444)' }}>1,220,000.00</td>
              </tr>

              <tr style={{ background: 'var(--color-ecfdf5, #ECFDF5)', fontWeight: 900, fontSize: '0.95rem', borderTop: '2px solid var(--accent-green, #10B981)' }}>
                <td style={{ padding: '14px 12px', color: 'var(--color-065f46, #065F46)' }} colSpan={2}>NET OPERATING PROFIT (EBIT)</td>
                <td style={{ padding: '14px 12px', textAlign: 'right', color: 'var(--color-047857, #047857)' }}>AED 630,000.00</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {statementType === 'audit-pack' && (
        <div style={{ background: 'var(--white, #FFFFFF)', borderRadius: '12px', border: '1px solid var(--text-secondary, #E2E8F0)', padding: '1.5rem' }}>
          ...
          <p style={{ margin: '0 0 1.25rem 0', fontSize: '0.82rem', color: 'var(--text-secondary, #64748B)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
            <div style={{ padding: '1rem', borderRadius: '8px', border: '1px solid var(--text-secondary, #E2E8F0)', background: 'var(--color-f8fafc, #F8FAFC)' }}>
              <div style={{ fontWeight: 800, color: 'var(--color-1e293b, #1E293B)', fontSize: '0.9rem' }}>📁 RERA Compliance Binder</div>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary, #64748B)', marginTop: '0.25rem' }}>Escrow audit trails, Form 12 records, broker card renewals</div>
              <button style={{ marginTop: '0.75rem', background: 'var(--color-1e293b, #1E293B)', color: 'var(--white, #FFFFFF)', border: 'none', borderRadius: '6px', padding: '5px 12px', fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer' }}>
                Download ZIP
              </button>
            </div>

            <div style={{ padding: '1rem', borderRadius: '8px', border: '1px solid var(--text-secondary, #E2E8F0)', background: 'var(--color-f8fafc, #F8FAFC)' }}>
              <div style={{ fontWeight: 800, color: 'var(--color-1e293b, #1E293B)', fontSize: '0.9rem' }}>📁 FTA Tax & VAT Ledger</div>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary, #64748B)', marginTop: '0.25rem' }}>Quarterly Form 201 summaries, input VAT receipts, TRN verification</div>
              <button style={{ marginTop: '0.75rem', background: 'var(--color-1e293b, #1E293B)', color: 'var(--white, #FFFFFF)', border: 'none', borderRadius: '6px', padding: '5px 12px', fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer' }}>
                Download PDF
              </button>
            </div>
      ...
      {statementType === 'balance-sheet' && (
        <div style={{ background: 'var(--white, #FFFFFF)', borderRadius: '12px', border: '1px solid var(--text-secondary, #E2E8F0)', padding: '1.5rem' }}>
          <h3 style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem', fontWeight: 800, color: 'var(--color-1e293b, #1E293B)' }}>
            Balance Sheet & General Ledger Snapshot
          </h3>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1rem', marginTop: '1rem' }}>
            <div style={{ padding: '1rem', background: 'var(--color-f8fafc, #F8FAFC)', borderRadius: '8px', border: '1px solid var(--text-secondary, #E2E8F0)' }}>
              <div style={{ fontWeight: 800, color: 'var(--color-1e293b, #1E293B)' }}>Total Current Assets</div>
              <div style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--accent-green, #10B981)', marginTop: '0.25rem' }}>AED 1,420,000</div>
              <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary, #64748B)' }}>Cash at Bank (Wio), AR, Security Deposits (1210)</div>
            </div>
            <div style={{ padding: '1rem', background: 'var(--color-f8fafc, #F8FAFC)', borderRadius: '8px', border: '1px solid var(--text-secondary, #E2E8F0)' }}>
              <div style={{ fontWeight: 800, color: 'var(--color-1e293b, #1E293B)' }}>Total Current Liabilities</div>
              <div style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--accent-red, #EF4444)', marginTop: '0.25rem' }}>AED 285,000</div>
              <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary, #64748B)' }}>VAT Payable, Unpaid Broker Commissions</div>
            </div>
            <div style={{ padding: '1rem', background: 'var(--color-f8fafc, #F8FAFC)', borderRadius: '8px', border: '1px solid var(--text-secondary, #E2E8F0)' }}>
              <div style={{ fontWeight: 800, color: 'var(--color-1e293b, #1E293B)' }}>Owner's Equity & Retained Earnings</div>
              <div style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--accent-purple, #8B5CF6)', marginTop: '0.25rem' }}>AED 1,135,000</div>
              <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary, #64748B)' }}>Includes Director's Loan Account (2110)</div>
            </div>
          </div>
        </div>
      )}
