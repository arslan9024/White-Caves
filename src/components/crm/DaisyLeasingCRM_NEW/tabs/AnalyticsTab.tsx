...
const ProgressBar: React.FC<{ label: string; pct: number; color: string; value?: string }> = ({
  label,
  pct,
  color,
  value,
  ...
  return (
    <div className="analytics-view">
      ...
      >
        ...
        >
          <h4 style={{ margin: '0 0 16px', fontSize: '14px', color: 'var(--color-text-primary)' }}>
            P&L Breakdown
          </h4>
          {[
          ...
          <div
            style={{
              borderTop: '1px solid var(--rgba-white-10)',
              paddingTop: '10px',
              display: 'flex',
              justifyContent: 'space-between',
              alignItems: 'center',
        ...
        >
          ...
          >
            Total cheques: {pdcTotal} · Value: AED{' '}
            {pdcCheques.reduce((s, c) => s + c.amount, 0).toLocaleString()}
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <h4 style={{ margin: '0 0 14px', fontSize: '14px', color: 'var(--color-text-primary)' }}>
            Pipeline Funnel
          </h4>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          ...
          >
            <h4
              style={{ margin: '0 0 12px', fontSize: '14px', color: 'var(--color-text-primary)' }}
            >
              Renewal Forecast
            </h4>
            {[
